package Ankama_Common
{
    ...
    import Ankama_Common.ui.WebPortal;
    ...
    public class Common extends Sprite 
    {
        ...
        private var _secureModeNeedReboot:Object = {"reboot":false};
        ...
        public function main():void
        {
            ...
            this.sysApi.addHook(OpenEvolutiveFeed, this.onOpenEvolutiveFeed);
            this.sysApi.addHook(OpenMountFeed, this.onOpenMountFeed);
            this.sysApi.addHook(OpenItemsList, this.onOpenItemsList);
        ...
        public function openIllustratedPopup(content:String, illustrationFileName:String, onClose:Function=null):String
        {
            this._currentPopupNumber++;
            var params:Object = new Object();
            params.content = content;
            params.illustrationFileName = illustrationFileName;
            params.onClose = onClose;
            var popupName:String = ("popup" + ++this._popupId);
            this.uiApi.loadUi("illustratedPopup", popupName, params, 3);
            return (popupName);
        }

        public function openIllustratedWithLinkPopup(title:String, content:String, link:String, illustrationFileName:String, onClose:Function=null, btnText:String="", onButtonRelease:Function=null, onButtonKnowMoreRelease:Function=null, strata:int=3):String
        {
            this._currentPopupNumber++;
            var params:Object = new Object();
            params.title = title;
            ...
            params.link = link;
            params.illustrationFileName = illustrationFileName;
            params.onButtonRelease = onButtonRelease;
            params.onButtonKnowMoreRelease = onButtonKnowMoreRelease;
            params.onClose = onClose;
            params.btnText = btnText;
            var popupName:String = ("popup" + ++this._popupId);
            this.uiApi.loadUi("illustratedWithLinkPopup", popupName, params, strata);
            return (popupName);
        }
