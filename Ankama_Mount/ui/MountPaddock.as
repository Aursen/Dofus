package Ankama_Mount.ui
{
    ...
    public class MountPaddock 
    {
        ...
        private var _hookedComponents:Dictionary = new Dictionary(true);
        ...
        private function getCapacityAndModelFilterInBarn(dataProvider:*, checkSubFilter:Boolean=false, comboBoxRequester:ComboBox=null):Array
        {
            ...
            if (checkSubFilter)
            {
                ...
                {
                    if (this.cb_barn.value.filterGroup == MountFilterGroupEnum.MODEL)
                    {
                        modeleAdded.push(this.cb_barn.value.type);
                    }
                    else
                    {
                        if (this.cb_barn.value.filterGroup == MountFilterGroupEnum.FAMILY)
                        {
                ...
                if (this.cb_barn2)
                {
                    ...
                    {
                        if (this.cb_barn2.value.filterGroup == MountFilterGroupEnum.MODEL)
                        {
                            modeleAdded.push(this.cb_barn2.value.type);
                        }
                        else
                        {
                            if (this.cb_barn2.value.filterGroup == MountFilterGroupEnum.FAMILY)
                            {
            ...
            if (comboBoxRequester)
            {
                ...
                {
                    if (comboBoxRequester.value.filterGroup == MountFilterGroupEnum.MODEL)
                    {
                    ...
                    {
                        if (comboBoxRequester.value.filterGroup == MountFilterGroupEnum.FAMILY)
                        {
        ...
        private function findFilterIndex(comboBox:ComboBox, searchedLabel:String):int
        {
            var i:int;
            i = 0;
            while (i < comboBox.dataProvider.length)
            {
            ...
            switch (target)
            {
                case this.gd_barn:
                    if (this.gd_barn.selectedIndex != -1)
                    {
                        ...
                        if (selectMethod == 1)
                        {
                            this.sysApi.sendAction(new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTPADDOCK_PUT, [this.gd_barn.selectedItem.id]));
                            this.sourceSelected(-1);
                        }
                        else
                        {
                ...
                case this.gd_paddock:
                    if (this.gd_paddock.selectedIndex != -1)
                    {
                        ...
                        if (selectMethod == 1)
                        {
                            this.sysApi.sendAction(new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTPADDOCK_GET, [this.gd_paddock.selectedItem.id]));
                        }
                        else
                        {
        ...
        public function onRelease(target:Object):void
        {
            ...
            var barnMountsId:Array;
            var paddockMountsId:Array;
            var certificat:*;
            var inventoryMountsId:Array;
            var deActivateContextMenuChoices:Boolean;
            switch (target)
            {
                ...
                case this.btn_moveAllFromBarn:
                    ...
                    contextMenu.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.mount.transfertAllToPaddock"), this.sysApi.sendAction, [new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTPADDOCK_PUT, barnMountsId)], deActivateContextMenuChoices, null, false, true));
                    contextMenu.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.mount.transfertAllToInventory"), this.sysApi.sendAction, [new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTSTABLES_CERTIF, barnMountsId)], deActivateContextMenuChoices, null, false, true));
                ...
                case this.btn_moveAllFromPark:
                    ...
                    contextMenu.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.mount.transfertAllToBarn"), this.sysApi.sendAction, [new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTPADDOCK_GET, paddockMountsId)], deActivateContextMenuChoices, null, false, true));
                    contextMenu.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.mount.transfertAllToInventory"), this.sysApi.sendAction, [new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTPADDOCK_CERTIF, paddockMountsId)], deActivateContextMenuChoices, null, false, true));
                    this.modContextMenu.createContextMenu(contextMenu);
                    break;
                case this.btn_moveAllFromInventory:
                    ...
                    contextMenu.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.mount.transfertAllToBarn"), this.sysApi.sendAction, [new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_MOUNTSTABLES_UNCERTIF, inventoryMountsId)], deActivateContextMenuChoices, null, false, true));
                    contextMenu.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.mount.transfertAllToPaddock"), this.sysApi.sendAction, [new ExchangeHandleMountStable(ExchangeHandleMountStableTypeEnum.EXCHANGE_UNCERTIF_TO_PADDOCK, inventoryMountsId)], deActivateContextMenuChoices, null, false, true));
                    this.modContextMenu.createContextMenu(contextMenu);
                    break;
        ...
        {
            this._infoRequestTimer.stop();
            this.sysApi.sendAction(new MountInfoRequest(this._infoRequestSelectedItem));
        }
