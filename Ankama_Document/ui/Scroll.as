    ...
    public class Scroll extends DocumentBase 
    {
        ...
        private function _initScroll():void
        {
            ...
            else
            {
                ...
                this.lbl_content.x = ((this._illuUri) ? this._contentXWithIllu : this._contentX);
                if (this._image != null)
                {
                    if (this._image.width > 0)
                    {
        ...
        private function showTitle(pShow:Boolean):void
        {
            ...
            this.tx_deco.visible = ((this._hideTitleDecoration) ? false : pShow);
        }
        ...
        private function applyProperties():void
        {
            ...
            if (this._properties)
            {
                ...
                {
                    if (this._properties.hasOwnProperty("cssClass"))
                    {
