package Ankama_Document.ui
{
    ...
    public class ReadingBook extends DocumentBase 
    {
        ...
        private var _leftPageTextureList:Vector.<Texture> = new Vector.<Texture>();
        private var _rightPageTextureList:Vector.<Texture> = new Vector.<Texture>();
        ...
        private var _loadingData:Dictionary = new Dictionary(true);
        private var _rectList:Vector.<LinkData> = new Vector.<LinkData>();
        ...
        private function addTextureOnPage(page:GraphicContainer, target:Object):void
        {
            ...
            switch (textureData.align)
            {
                case "right":
                    ...
                    break;
                case "center":
                    posX = int(((page.width - textureData.width) / 2));
                    break;
                case "left":
                default:
                    posX = 0;
