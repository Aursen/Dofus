package Ankama_Dungeon.ui
{
    ...
    public class BreachBossSelection 
    {
        ...
        public function main(oParam:Object=null):void
        {
            ...
            this.sysApi.addHook(BreachBuyRoom, this.onUnlockRoom);
        ...
        public function updateBosses(data:*, componentsRef:*, selected:Boolean):void
        {
            ...
            var priceStr:String;
            var newSize:Number;
            var marginCurrency:Number;
            var margin:Number;
            var newButtonX:Number;
            var toMoveX:Number;
            ...
            if (data)
            {
                ...
                {
                    if (difficulty == EnumRoomDifficulty.HARD_ROOM)
                    {
        ...
        public function onRelease(target:Object):void
        {
            switch (target)
            {
                ...
                default:
                    ...
                    {
                        this.sysApi.sendAction(new BreachRoomUnlock(this._componentsList[target.name].room));
                    };
            };
        }
        ...
        {
            var ttData:Object;
            var breachDungeonModificator:BreachDungeonModificator;
            var spellTooltipSettings:SpellTooltipSettings;
            var monsterGroup:Vector.<MonsterInGroupLightInformations>;
            var branchInfo:Object;
            var rewardToObtain:Object;
            var toDisplay:Object;
            var locks:Vector.<uint>;
            var reward:BreachPrize;
            var prizeCurrency:Boolean;
            var data:Object;
            var prize:BreachPrize;
            var dataCurrency:Object;
            ...
            {
                if (target.name.indexOf("ed_boss") != -1)
                {
                    if (this._componentsList[target.name])
                    {
                ...
                else
                {
                    ...
                    {
                        if (target.name.indexOf("ctr_fragments") != -1)
                        {
                            ttData = {
                        ...
                        {
                            if (target.name.indexOf("lbl_diffScore") != -1)
                            {
                                rewardToObtain = {};
                            ...
                            {
                                if (target.name.indexOf("ctr_bonus") != -1)
                                {
                                ...
                                {
                                    if (target.name.indexOf("tx_bonusCurrency") != -1)
                                    {
                                    ...
                                    {
                                        if (target.name.indexOf("btn_buyRoom") != -1)
                                        {
        ...
        {
            var branch:BreachBranchWrapper;
