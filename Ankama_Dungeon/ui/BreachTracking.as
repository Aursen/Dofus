package Ankama_Dungeon.ui
{
    ...
    import d2hooks.BreachBonus;
    import d2hooks.BreachBudget;
    import d2hooks.BreachCharactersListUpdate;
    ...
    public class BreachTracking 
    {
        ...
        private var _bosses:Vector.<MonsterInGroupLightInformations> = new Vector.<MonsterInGroupLightInformations>();
        ...
        public function main(params:Object=null):void
        {
            ...
            this.sysApi.addHook(BreachBonus, this.onBreachBonus);
            this.sysApi.addHook(BreachBudget, this.onBreachBudget);
            this.sysApi.addHook(BreachCharactersListUpdate, this.onBreachCharactersListUpdate);
        ...
        {
            var e:EffectInstanceInteger;
            var boss:MonsterInGroupLightInformations;
            this._dataMatrix = new Array();
        ...
        {
            var ctrMainQuestList:GraphicContainer;
            var topMargin:uint;
            ...
            if (((questListUi) && (questListUi.visible)))
            {
                ...
                {
                    if (((ctrMainQuestList.y + ctrMainQuestList.contentHeight) + this.mainCtr.contentHeight) < this.uiApi.getStageHeight())
                    {
                        this.mainCtr.x = 0;
        ...
        public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean):void
        {
            if (target == this.gd_breachTracking)
            {
                ...
                {
                    if (((target.selectedItem) && (!(target.selectedItem.isCat))))
                    {
