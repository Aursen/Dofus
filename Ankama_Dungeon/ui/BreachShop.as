package Ankama_Dungeon.ui
{
    ...
    import d2hooks.BreachRewardBought;
    import d2hooks.BreachSaveBought;
    import d2hooks.BreachSaved;
    ...
    import d2actions.BreachSaveBuy;
    import d2actions.BreachRewardBuy;
    ...
    public class BreachShop 
    {
        ...
        public function main(oParam:Object=null):void
        {
            ...
            this.sysApi.addHook(BreachRewardBought, this.onRewardBought);
            this.sysApi.addHook(BreachSaveBought, this.onSaveBought);
            this.sysApi.addHook(BreachSaved, this.onSaveBought);
            this.sysApi.addHook(BreachBudget, this.onUpdateBudget);
        ...
        public function onRelease(target:Object):void
        {
            ...
            {
                this.sysApi.sendAction(new BreachSaveBuy());
            }
            else
            {
                if (target.name.indexOf("btn_buyReward") != -1)
                {
                    this.sysApi.sendAction(new BreachRewardBuy(this._componentsList[target.name].id));
                };
            };
        }
