package Ankama_Web.ui
{
    ...
    public class CodeResultPopup 
    {
        ...
        public function main(params:Object=null):void
        {
            ...
            var containsAbo:Boolean;
            var containsOgrines:Boolean;
            var nbOrder:int;
            ...
            if (data.order_list.length > 0)
            {
                ...
                giftName = data.order_list[0].articles[0].name;
            ...
            {
                if (data.kard_list.length > 0)
                {
                    iconUri = data.kard_list[0].image;
                    giftName = data.kard_list[0].name;
                };
            };
            var _local_8:int = CodeResultPopup.OBJECTS;
            if (containsAbo)
            {
                if (((nbOrder < 2) && (data.kard_list.length == 0)))
                {
                    _local_8 = CodeResultPopup.ABO;
                }
                else
                {
                    _local_8 = CodeResultPopup.PACK;
                };
            }
            else
            {
                if (containsOgrines)
                {
                    if (((nbOrder < 2) && (data.kard_list.length == 0)))
                    {
                        _local_8 = CodeResultPopup.OGRINES;
                    }
                    else
                    {
                        _local_8 = CodeResultPopup.PACK;
            ...
            this.ctr_ogrine.visible = ((_local_8 == CodeResultPopup.OGRINES) && (nbOrder < 2));
