package Ankama_Web.ui
{
    ...
    import d2hooks.CodesAndGiftConsumeMultipleKardSuccess;
    import d2actions.ConsumeMultipleKard;
    ...
    import d2hooks.CodesAndGiftOpenBoxStats;
    ...
    public class MysteryBoxPopup 
    {
        ...
        public function main(params:Object=null):void
        {
            ...
            this.sysApi.addHook(CodesAndGiftConsumeMultipleKardSuccess, this.onConsumeMB);
        ...
        private function openMysteryBox():void
        {
            ...
            this.sysApi.sendAction(new ConsumeMultipleKard(this.openingMBId));
        ...
        private function getRarity(mysteryBoxKards:Array, resultId:uint):Object
        {
            var kard:Object;
        ...
        public function onRelease(target:Object):void
        {
            switch (target)
            {
                ...
                case this.btn_goToShop:
                    this.sysApi.sendAction(new OpenWebService("webShop", {"categoryId":DofusShopEnum.MYSTERY_CATEGORY_ID}));
                    this.uiApi.unloadUi(this.uiApi.me().name);
                    break;
            };
        }
        ...
        public function onAnimComplete(displayContent:Boolean=true):void
        {
            ...
            this.sysApi.dispatchHook(CodesAndGiftOpenBoxStats, this._mbToOpen.id, this._mbStockIds.length, (this._dateAnimEndStats - this._dateAnimStartStats), this._isAnimSkipped);
        }
        ...
        private function onConsumeMB(result:Array):void
        {
            if (this._mbStockIds.length == 0)
            {
                this.sysApi.dispatchHook(CodesAndGiftNoMoreMysteryBox, this._mbToOpen.id);
            };
