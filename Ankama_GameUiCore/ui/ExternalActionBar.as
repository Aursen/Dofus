package Ankama_GameUiCore.ui
{
    ...
    public class ExternalActionBar extends ActionBar 
    {
        ...
        override public function onRelease(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.btn_minimize:
                    ...
                    this.backgroundCtr.bgAlpha = ((this.actionBarCtr.visible) ? 0.7 : 0);
                    break;
            };
        }
        ...
        {
            var bar:ExternalActionBar;
            var barBounds:Rectangle;
            var barsBoundsLength:uint;
            var i:int;
