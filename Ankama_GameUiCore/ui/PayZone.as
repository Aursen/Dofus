package Ankama_GameUiCore.ui
{
    ...
    public class PayZone 
    {
        ...
        public function main(args:Array):void
        {
            ...
            this._link = this.uiApi.getText("ui.link.subscribe");
        ...
        public function onPopupButtonRelease():void
        {
        ...
        private function showPopup(show:Boolean):void
        {
            ...
            {
                this._popupName = this.modCommon.openIllustratedWithLinkPopup(this._title, this._description, null, "tx_illu_subscribe.jpg", null, this._buttonText, this.onPopupButtonRelease);
            }
            else
            {
                if (!show)
        ...
        private function updateDescriptionAccordingToMode():void
        {
            ...
            {
                this._description = this.uiApi.getText("ui.payzone.description");
            }
            else
            {
                if (this._mode == PAY_ZONE_JOB_MODE)
                {
                    this._description = this.uiApi.getText("ui.payzone.job");
                }
                else
                {
                    if (this._mode == PAY_ZONE_HAVENBAG_MODE)
                    {
                        this._description = this.uiApi.getText("ui.payzone.havenbag");
                    };
                };
            };
        }
