package Ankama_House.ui
{
    ...
    public class HouseGuildManager 
    {
        ...
        public function main(arg:*):void
        {
            ...
            this.sysApi.sendAction(new HouseGuildRightsView(this._house.houseId, this._house.houseInstances[0].id));
        ...
        private function showEmblem():void
        {
            ...
            {
                if (((!(this._myGuild)) || (this._myGuild.guildId == this._houseSharingGuild.guildId)))
                {
                    this.ctr_oneEmblem.visible = true;
                    this.ctr_twoEmblems.visible = false;
        ...
        {
            this.cbGuildHouseEnabled.selected = ((0x01 & (rights >> 0)) == 1);
            this.cbAccessGuildmatesHouse.selected = ((0x01 & (rights >> 3)) == 1);
            this.cbAccessHouseDenyOthers.selected = ((0x01 & (rights >> 4)) == 1);
            this.cbGuildmatesAccessSafes.selected = ((0x01 & (rights >> 5)) == 1);
            this.cbForbiddenSafes.selected = ((0x01 & (rights >> 6)) == 1);
            this.cbAllowTeleport.selected = ((0x01 & (rights >> 7)) == 1);
            this.cbAllowRespawn.selected = ((0x01 & (rights >> 8)) == 1);
        }
        ...
        {
            var guildToDisplay:GuildWrapper;
            var icon:EmblemSymbol;
            var icono:EmblemSymbol;
            var iconn:EmblemSymbol;
            if (this._houseSharingGuild)
            {
        ...
        {
            this.sysApi.sendAction(new HouseGuildShare(this._house.houseId, this._house.houseInstances[0].id, this.cbGuildHouseEnabled.selected, this.rightsToInt()));
            this.uiApi.unloadUi(this.uiApi.me().name);
        }
