package Ankama_Console.ui
{
    ...
    public class ConsoleUi 
    {
        ...
        private var _paramsRE:RegExp = new RegExp("'[a-zA-Z-*]*'", "g");
        ...
        private function output(text:String, _arg_2:uint=0):void
        {
            var alphaMode:String = ((this._options.opacity != 100) ? "alpha" : "");
            this.taConsole.appendText(text, ((_arg_2 == 0) ? ("p" + alphaMode) : (((_arg_2 == 1) ? ("pinfo" + alphaMode) : (((_arg_2 == 2) ? ("perror" + alphaMode) : (("p" + alphaMode))))))));
        ...
        public function extendConsole(extend:Boolean):void
        {
            ...
            this.mainContainer.width = ((extend) ? 1 : 0.8);
            this.mainContainer.height = ((extend) ? 0.8 : 0.2);
            this.ctr_insideConsole.height = ((extend) ? 0.98 : 0.95);
            this.sysApi.setData("consoleExtended", extend, DataStoreEnum.BIND_ACCOUNT);
            this.uiApi.me().render();
        }

        private function onConsoleOutput(msg:String, _arg_2:uint):void
        {
        ...
        private function onKeyUp(pTarget:Object, pKeyCode:uint):void
        {
            ...
            {
                if (((this._autoCompleteRunning) && (pKeyCode == Keyboard.ESCAPE)))
                {
                    this._autoCompleteRunning = false;
                };
            };
        ...
        {
            var alphaMenu:Array;
            var fontSizeMenu:Array;
            var openConsoleMenu:Array;
            var autoCompleteMenu:Array;
            switch (target)
            {
                case this.btnClose:
