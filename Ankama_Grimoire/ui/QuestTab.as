package Ankama_Grimoire.ui
{
    ...
    public class QuestTab 
    {
        ...
        private static const FLAG_COLOR:uint = 0x66CC00;
        ...
        public function main(oParam:Object=null):void
        {
            ...
            this.sysApi.addHook(QuestFollowed, this.onQuestFollowed);
            this.sysApi.addHook(QuestObjectiveValidated, this.onQuestObjectiveValidated);
        ...
        private function updateStep(completedQuest:Boolean=false):void
        {
            ...
            var cpt:uint;
            this.ctn_slots.x = (((txtXp > 0) || (txtKamas > 0)) ? this.uiApi.me().getConstant("reward_slot_with_xp_x") : this.uiApi.me().getConstant("reward_slot_without_xp_x"));
        ...
        private function showOrHideCategory(categoryId:uint, _arg_2:uint=0):void
        {
...
"y":objectiveFlagInfos.y
        ...
        private function checkMaxFollowedQuests(questId:uint):Boolean
        {
            ...
            {
                this.sysApi.dispatchHook(TextInformation, this.uiApi.getText(((maxFollowedQuests < 5) ? "ui.quest.increasableMaxQuestsReached" : "ui.quest.maxQuestsReached")), ChatActivableChannelsEnum.PSEUDO_CHANNEL_INFO, this.timeApi.getTimestamp());
                return (true);
            };
            return (false);
        }
        ...
        public function onRelease(target:Object):void
        {
            ...
            if (target.name.substr(0, 7) == "btn_loc")
            {
                ...
                if (objective)
                {
                    ...
                    {
                        this.sysApi.dispatchHook(RemoveMapFlag, objectiveFlagInfos.id, objectiveFlagInfos.worldMapId);
                    };
                };
            };
            ...
            {
                if (target.name.indexOf("tx_followQuest") == 0)
                {
                    ...
                    {
                        if (this._aTxFollowQuestsIds[target] == this._selectedQuest)
                        {
                            this.followQuest(this._selectedQuest);
                        }
                        else
        ...
        public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean):void
        {
            ...
            switch (target)
            {
                case this.gd_quests:
                    ...
                    {
                        if (((selectedItem.isCategory) && (!(selectMethod == SelectMethodEnum.AUTO))))
                        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (target.name.indexOf("tx_questComplete") == 0)
                                    {
                                    ...
                                    {
                                        if (target.name.indexOf("tx_repeatable") == 0)
                                        {
                                        ...
                                        {
                                            if (target.name.indexOf("tx_questIcon") == 0)
                                            {
