package Ankama_Grimoire.ui
{
    ...
    public class SpellList 
    {
        ...
        private var _allSpellCache:Dictionary = new Dictionary();
        private var _showAllObtentionLevels:Boolean = false;
        private var _showSpellTypeId:uint = 0xFFFFFFFF;
        ...
        private function updateSpellGrid(force:Boolean=false):void
        {
            ...
            var variants:Array;
            var spellLevelInfos:SpellLevel;
        ...
        public function onRelease(target:Object):void
        {
            ...
            {
                if (target == this.btn_showAllObtentionLevels)
                {
        ...
        {
            var data:Object;
            var spellItem:SpellWrapper;
            var btnSpellName:String;
            var btnSpellNameArray:Array;
            var i:int;
            var spellWrapper:SpellWrapper;
            var point:uint = 7;
            var relPoint:uint = 1;
            ...
            {
                if (target.name.indexOf("tx_lock") != -1)
                {
                    data = this._componentsList[target.name];
        ...
        {
            var spellWrapperArray:Array;
            var i:int;
            var spell:SpellWrapper;
            var isNewHighlighted:Boolean;
            var isAlreadyHighlighted:Boolean;
            var indexToUpdate:Array = [];
            i = 0;
            while (i < this.gd_spell.dataProvider.length)
            {
