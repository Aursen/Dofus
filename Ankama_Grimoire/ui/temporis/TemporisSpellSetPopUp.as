    ...
    public class TemporisSpellSetPopUp 
    {
        ...
        private function deleteSpellSet(spellSetDescr:Object, isForce:Boolean=false):void
        {
            ...
            else
            {
                ...
                this.systemApi.sendAction(new PresetDeleteRequest(spellSetDescr.spellSetId));
            };
        }
        ...
        private function submitSpellSet():void
        {
            ...
            this.lbl_error.text = "";
            var buildId:int = ((this._actionId === ACTION_CREATE_SPELL_SET) ? -1 : this._spellSetDescr.spellSetId);
            this._isPresetSaving = true;
            this.systemApi.sendAction(new CharacterPresetSaveRequest(buildId, this._spellSetDescr.spellSetIconId, this._spellSetDescr.spellSetName, true, SavablePresetTypeEnum.SPELL_PRESET));
        }
        ...
        private function checkBuildName(buildName:String):Object
        {
            ...
            {
                if (buildName.length > this._buildNameNamingRule.maxLength)
                {
                ...
                {
                    if (!this._buildNameRegex.test(buildName))
                    {
