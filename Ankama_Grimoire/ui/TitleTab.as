package Ankama_Grimoire.ui
{
    ...
    public class TitleTab 
    {
        ...
        private var _allTitles:Array = new Array();
        private var _myTitles:Array = new Array();
        private var _myTitlesIds:Array = new Array();
        private var _dataTitles:Object;
        private var _allOrnaments:Array = new Array();
        private var _myOrnaments:Array = new Array();
        private var _myOrnamentsIds:Array = new Array();
        ...
        private function onCharacterStatsList(oneLifePointRegenOnly:Boolean=false):void
        {
            if (((!(oneLifePointRegenOnly)) && (this.switchWarningVisiblity())))
            {
                ...
                this._ornamentId = ((this._wingsOut) ? 0 : this.gd_orns.selectedItem.id);
