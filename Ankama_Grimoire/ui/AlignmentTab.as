package Ankama_Grimoire.ui
{
    ...
    public class AlignmentTab 
    {
        ...
        private var _listRanksID:Vector.<int> = new Vector.<int>(6, true);
        ...
        public function main(oParam:Object=null):void
        {
            ...
            else
            {
                ...
                {
                    if (alignment == AlignmentSideEnum.ALIGNMENT_EVIL)
                    {
