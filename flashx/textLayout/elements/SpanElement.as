package flashx.textLayout.elements
{
    ...
    public class SpanElement extends FlowLeafElement 
    {
        ...
        private static const _newLineTabPattern:RegExp = /[\x09\n\r]/g;
        private static const _tabPlaceholderPattern:RegExp = //g;
        private static const anyPrintChar:RegExp = /[^\x09\n\r ]/g;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                str = (str + String.fromCharCode(0xE000));
                            }
                            else
                            {
                                if (elem != null)
        ...
        override tlf_internal function mergeToPreviousIfPossible():Boolean
        {
            var myidx:int;
            var sib:SpanElement;
            var thisIsSimpleTerminator:Boolean;
            var p:ParagraphElement;
            var prevLeaf:FlowLeafElement;
