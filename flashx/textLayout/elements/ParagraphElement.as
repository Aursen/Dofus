package flashx.textLayout.elements
{
    ...
    public final class ParagraphElement extends ParagraphFormattedElement 
    {
        ...
        tlf_internal function releaseLineCreationData():void
        {
            ...
            {
                var _local_5:* = tb;
                (_local_5["releaseLineCreationData"]());
            };
        }
        ...
        {
            var lineJust:String;
            var spaceJustifier:SpaceJustifier;
            var newMinimumSpacing:Number;
            var newMaximumSpacing:Number;
            var newOptimumSpacing:Number;
            var eastAsianJustifier:Object;
            var tabStops:Vector.<TabStop>;
            var tsa:TabStopFormat;
            var token:String;
        ...
        override tlf_internal function normalizeRange(normalizeStart:uint, normalizeEnd:uint):void
        {
            ...
            var newChildEnd:int;
            var prevElement:FlowElement;
            var lastChild:FlowElement;
            var s:SpanElement;
