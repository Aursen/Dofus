package flashx.textLayout.elements
{
    ...
    public class FlowElement implements ITextLayoutFormat 
    {
        ...
        tlf_internal static function createTextLayoutFormatPrototype(localStyles:ITextLayoutFormat, parentPrototype:TextLayoutFormat):TextLayoutFormat
        {
            ...
            var noInheritParentStylesPrototype:Object;
            var lvh:TextLayoutFormat;
            var coreStyles:Object;
            var parentPrototypeUsable:Boolean = true;
            var hasStylesSet:Boolean;
            if (parentPrototype)
            {
            ...
            var hasNonInheritedStyles:Boolean;
            if (localStyles != null)
            {
        ...
        {
            var contElement:ContainerFormattedElement;
        ...
        tlf_internal function get formatForCascade():ITextLayoutFormat
        {
            ...
            var explicitStyle:TextLayoutFormat;
        ...
        {
            var absoluteEndPos:int;
            var absStartIdx:int;
            var charsDeletedFromCurContainer:int;
            var enclosingController:ContainerController;
            var enclosingControllerBeginningPos:int;
            var containerTextLengthDelta:int;
            var flowComposer:IFlowComposer;
            var myIdx:int;
            var previousEnclosingWithContent:ContainerController;
            if (this.getTextFlow())
            {
