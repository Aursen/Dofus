package flashx.textLayout.elements
{
    ...
    public final class LinkElement extends SubParagraphGroupElementBase implements IEventDispatcher 
    {
        ...
        {
            getEventMirror().addEventListener(_arg_1, listener, useCapture, priority, useWeakReference);
        }
        ...
        public function hasEventListener(_arg_1:String):Boolean
        {
            ...
            return (_eventMirror.hasEventListener(_arg_1));
        }
        ...
        public function removeEventListener(_arg_1:String, listener:Function, useCapture:Boolean=false):void
        {
            if (hasActiveEventMirror())
            {
                _eventMirror.removeEventListener(_arg_1, listener, useCapture);
            };
        }
        ...
        public function willTrigger(_arg_1:String):Boolean
        {
            ...
            return (_eventMirror.willTrigger(_arg_1));
        }
        ...
        {
            var resultingTextLayoutFormat:TextLayoutFormat;
        ...
        {
            var oldCharAttrs:ITextLayoutFormat;
            var newCharAttrs:ITextLayoutFormat;
            var tf:TextFlow;
