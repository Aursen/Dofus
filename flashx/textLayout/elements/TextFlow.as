package flashx.textLayout.elements
{
    ...
    public class TextFlow extends ContainerFormattedElement implements IEventDispatcher 
    {
        ...
        {
            var oldSWFContext:ISWFContext;
            var newSWFContext:ISWFContext;
        ...
        {
            var rslt:ITextLayoutFormat;
            var tlfvh:TextLayoutFormat;
            if (this._formatResolver == null)
            {
                return (null);
            };
