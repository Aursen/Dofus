package flashx.textLayout.conversion
{
    ...
    public class TextFieldHtmlImporter extends BaseTextLayoutImporter implements IHTMLImporter 
    {
        ...
        tlf_internal static const anyPrintChar:RegExp = /[^\x09\n\r ]/g;
        ...
        {
            var newParent:FlowGroupElement;
        ...
        {
            var spge:SubParagraphGroupElement;
            importer.parseAttributes(xmlToParse, [_classAndIdImporter]);
        ...
        protected function toXMLInternal(source:String):XML
        {
            ...
            var result:Object;
            var tag:String;
            var hasStartModifier:Boolean;
            var name:String;
            var attrs:String;
            var hasEndModifier:Boolean;
            var innerResult:Object;
            var attrName:String;
            var val:String;
