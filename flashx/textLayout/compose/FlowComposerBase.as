package flashx.textLayout.compose
{
    ...
    public class FlowComposerBase 
    {
        ...
        public function addLine(newLine:TextFlowLine, workIndex:int):void
        {
            ...
            var oldCharCount:int;
            var deleteCount:int;
            var amtRemaining:int;
            var nextLine:int;
            ...
            {
                if (((workLine is TextFlowTableBlock) && (!(workLine == newLine))))
                {
                    this._lines.splice(workIndex, 1, newLine);
                }
                else
                {
                    if ((newLine is TextFlowTableBlock))
                    {
                        if (workLine != newLine)
                        {
        ...
        {
            var newBaseContext:ISWFContext;
            var oldBaseContext:ISWFContext;
