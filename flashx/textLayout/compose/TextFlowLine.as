package flashx.textLayout.compose
{
    ...
    public class TextFlowLine implements IVerticalJustificationLine 
    {
        ...
        tlf_internal function recreateTextLine(textBlock:TextBlock, previousLine:TextLine):TextLine
        {
            var textLine:TextLine;
            var numberLine:TextLine;
            var boxStartTotalIndent:Number;
            var paraStart:int;
            var elem:FlowLeafElement;
            var elemStart:int;
            var listItemElement:ListItemElement;
        ...
        tlf_internal function createAdornments(blockProgression:String, elem:FlowLeafElement, elemStart:int, textLine:TextLine, numberLine:TextLine):void
        {
            ...
            var elemFormat:ITextLayoutFormat;
            var imeStatus:*;
        ...
        {
            var numCharsSelecting:int;
            var endPos:int;
            var ilg:InlineGraphicElement;
            var floatInfo:FloatCompositionData;
            var blockRect:Rectangle;
            var leafBlockArray:Array;
            var leafBlockIter:int;
            var tcyBlock:FlowElement;
            var tcyParentRelativeEnd:int;
            var subParBlock:SubParagraphGroupElementBase;
            var largestTCYRise:Number;
            var lastTCYIdx:int;
            var tcyRects:Array;
            var tcyRectArray:Array;
            var tcyBlockIter:int;
            var tcyRect:Rectangle;
            var charCode:int;
            var lastElemBlockArray:Array;
            ...
            var curElem:FlowLeafElement;
            var largestRise:Number = 0;
            var blockRectArray:Array = [];
            var floatRectArray:Array;
            var tcyDrawRects:Array;
            for (;curIdx < endIdx;)
            {
        ...
        {
            var bidiBlock:Array;
            var bidiBlockIter:int;
            var curIdx:int;
            var incrementor:int;
            var activeStartIndex:int;
            var activeEndIndex:int;
            var curElementIndex:int;
            var activeEndIsBidi:Boolean;
            var curIsBidi:Boolean;
            var testILG:InlineGraphicElement;
            var verticalText:Boolean;
            var ilgFormat:ITextLayoutFormat;
        ...
        tlf_internal function computePointSelectionRectangle(idx:int, container:DisplayObject, prevLine:TextFlowLine, nextLine:TextFlowLine, constrainSelRect:Boolean):Rectangle
        {
            ...
            var prevElementIndex:int;
            var rlOnePoint:Point;
            var onePoint:Point;
            if (((this.isDamaged()) || (!(this._controller))))
            {
                return (null);
            ...
            var isTCYBounds:Boolean;
            var paraLeadingTCY:Boolean;
            var contElement:ContainerFormattedElement = this._para.getAncestorWithContainer();
            var blockProgression:String = contElement.computedFormat.blockProgression;
            var direction:String = this._para.computedFormat.direction;
            if (blockProgression == BlockProgression.RL)
        ...
        {
            var pointSelRect:Rectangle;
            var paraStart:int;
            var selCache:SelectionCache;
            var drawRect:Rectangle;
            var contElement:ContainerFormattedElement = this._para.getAncestorWithContainer();
            var blockProgression:String = contElement.computedFormat.blockProgression;
            var textLine:TextLine = this.getTextLine(true);
