package flashx.textLayout.edit
{
    public class SelectionFormat 
    {
        ...
        public function SelectionFormat(rangeColor:uint=0xFFFFFF, rangeAlpha:Number=1, rangeBlendMode:String="difference", pointColor:uint=0xFFFFFF, pointAlpha:Number=1, pointBlendMode:String="difference", pointBlinkRate:Number=500)
        {
