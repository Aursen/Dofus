package flashx.textLayout.edit
{
    ...
    public class EditManager extends SelectionManager implements IEditManager 
    {
        ...
        override public function keyDownHandler(event:KeyboardEvent):void
        {
            ...
            var discretionaryHyphenString:String;
                            ...
                            switch (event.charCode)
                            {
                                ...
                                case Keyboard.ENTER:
                                    if (textFlow.configuration.manageEnterKey)
                                    {
                                        ...
                                        {
                                            if (((event.shiftKey) && (((!(listItem)) && (textFlow.configuration.shiftEnterLevel > 0)) || (textFlow.configuration.shiftEnterLevel > 1))))
                                            {
                                                if (overwriteMode)
                                                {
                                                    this.overwriteText(" ");
        ...
        {
            var undoPsuedoOp:UndoOperation;
            var opEvent:FlowOperationEvent;
        ...
        {
            var opEvent:FlowOperationEvent;
            var redoPsuedoOp:RedoOperation;
            var rslt:SelectionState;
            var controllerIndex:int;
        ...
        {
            var curPos:int;
            var curPosCharCode:int;
            var prevPosCharCode:int;
            var nextPosCharCode:int;
