package flashx.textLayout.container
{
    ...
    public class ContainerController implements IInteractionEventHandler, ITextLayoutFormat, ISandboxSupport 
    {
        ...
        {
            var stopIdx:int;
            var prevController:ContainerController;
        ...
        tlf_internal function setTextLength(numChars:int):void
        {
            ...
            var containerAbsoluteStart:int;
            var uncomposedTextLength:int;
            if (this.textFlow)
            {
        ...
        tlf_internal function gatherVisibleLines(wmode:String, createShape:Boolean):void
        {
            ...
            if (this._textLength != 0)
            {
                ...
                adjustX = ((wmode == BlockProgression.RL) ? (this._xScroll - width) : this._xScroll);
        ...
        private function rangeToRectangle(start:int, end:int, startLineIndex:int, endLineIndex:int):Rectangle
        {
            ...
            var isTCY:Boolean;
            var minAtomIndex:int;
            var maxAtomIndex:int;
            var leafElement:FlowLeafElement;
            var atomIndex:int;
            var lastPosition:int;
            var pos:int;
            var startLine:TextFlowLine;
            var endLine:TextFlowLine;
        ...
        tlf_internal function attachTransparentBackgroundForHit(justClear:Boolean):void
        {
            ...
            var bgwidth:Number;
            var bgheight:Number;
            var adjustHorizontalScroll:Boolean;
            var bgx:Number;
            var bgy:Number;
        ...
        public function menuSelectHandler(event:ContextMenuEvent):void
        {
            ...
            var cbItems:ContextMenuClipboardItems;
            if (this.interactionManager)
            {
        ...
        tlf_internal function addSelectionShapes(selFormat:SelectionFormat, selectionAbsoluteStart:int, selectionAbsoluteEnd:int):void
        {
            ...
            var absoluteControllerStart:int;
            var absoluteControllerEnd:int;
            var begLine:int;
            var endLine:int;
            var selObj:Shape;
            var line:TextFlowLine;
        ...
        {
            return ((this.computedFormat.paddingLeft == FormatValue.AUTO) ? (this.computedFormat.borderLeftWidth + this.computedFormat.marginLeft) : ((this.computedFormat.paddingLeft + this.computedFormat.borderLeftWidth) + this.computedFormat.marginLeft));
        }

        tlf_internal function getEffectivePaddingRight():Number
        {
            return ((this.computedFormat.paddingRight == FormatValue.AUTO) ? (this.computedFormat.borderRightWidth + this.computedFormat.marginRight) : ((this.computedFormat.paddingRight + this.computedFormat.borderRightWidth) + this.computedFormat.marginRight));
        }

        tlf_internal function getEffectivePaddingTop():Number
        {
            return ((this.computedFormat.paddingTop == FormatValue.AUTO) ? (this.computedFormat.borderTopWidth + this.computedFormat.marginTop) : ((this.computedFormat.paddingTop + this.computedFormat.borderTopWidth) + this.computedFormat.marginTop));
        }

        tlf_internal function getEffectivePaddingBottom():Number
        {
            return ((this.computedFormat.paddingBottom == FormatValue.AUTO) ? (this.computedFormat.borderBottomWidth + this.computedFormat.marginBottom) : ((this.computedFormat.paddingBottom + this.computedFormat.borderBottomWidth) + this.computedFormat.marginBottom));
        }
        ...
        tlf_internal function updateCompositionShapes():void
        {
            ...
            this._mouseEventManager.updateHitTests((((this.effectiveBlockProgression == BlockProgression.RL) && (this._hasScrollRect)) ? this._contentWidth : 0), scratchRectangle, tf, ((firstVisibleLine) ? firstVisibleLine.absoluteStart : this._absoluteStart), ((lastVisibleLine) ? ((lastVisibleLine.absoluteStart + lastVisibleLine.textLength) - 1) : this._absoluteStart), this, needsCtrlKey);
        ...
        tlf_internal function updateGraphics(updateStart:int):void
        {
            ...
            var tfl:TextFlowLine;
            var i:int;
            var floatToRemove:DisplayObject;
            ...
            while (floatIndex < numFloats)
            {
                ...
                {
                    if (visibleFloats.indexOf(_local_5) < 0)
                    {
                        visibleFloats.push(_local_5);
                    };
                    if (floatInfo.floatType == Float.NONE)
                    {
                    ...
                    inlineHolder = _local_5.parent;
                    if ((((((containerListIndex < numContainerList) && (floatInfo.parent == this._container)) && (inlineHolder)) && (inlineHolder.parent == this._container)) && (_local_5 == this._floatsInContainer[containerListIndex])))
                    {
                        if (floatInfo.matrix)
                        {
                    ...
                    {
                        index = this._floatsInContainer.indexOf(_local_5);
                        ...
                        {
                            if (((containerListIndex < numContainerList) && (_local_5 == this._floatsInContainer[containerListIndex])))
                            {
                                containerListIndex++;
                            };
                            ...
                            inlineHolder.x = (inlineHolder.x + floatInfo.x);
                            inlineHolder.y = (inlineHolder.y + floatInfo.y);
                            inlineHolder.addChild(_local_5);
            ...
            {
                _local_5 = this._floatsInContainer[containerListIndex++];
                if (((_local_5.parent) && (visibleFloats.indexOf(_local_5) < 0)))
                {
                    this.removeInlineGraphicElement(_local_5.parent.parent, _local_5.parent);
                };
            };
        ...
        {
            var parentPrototype:TextLayoutFormat;
            if (!this._computedFormat)
            {
        ...
        {
            var tf:TextFlow;
            var elemStyle:TextLayoutFormat;
            var localFormat:ITextLayoutFormat;
        ...
        tlf_internal function testLineVisible(wmode:String, scrollXTW:int, scrollYTW:int, scrollWidthTW:int, scrollHeightTW:int, textFlowLine:TextFlowLine, textLine:TextLine):*
        {
            ...
            var rslt:* = (((wmode == BlockProgression.TB) ? this._measureHeight : this._measureWidth) ? 0 : textFlowLine.testLineVisible(wmode, scrollXTW, scrollYTW, scrollWidthTW, scrollHeightTW));
        ...
        tlf_internal function oldTestLineVisible(wmode:String, scrollXTW:int, scrollYTW:int, scrollWidthTW:int, scrollHeightTW:int, textFlowLine:TextFlowLine, textLine:TextLine):TextLine
        {
            ...
            if ((((wmode == BlockProgression.TB) ? this._measureHeight : this._measureWidth) || (textFlowLine.oldTestLineVisible(wmode, scrollXTW, scrollYTW, scrollWidthTW, scrollHeightTW))))
            {
        ...
        {
            var floatIndex:int;
            var lastFloatIndex:int;
            var inlineRect:Rectangle;
            var topLeft:Point;
            var floatInfo:FloatCompositionData;
            var inlineGraphicElement:InlineGraphicElement;
            var inlineHolder:DisplayObject;
            if (this._composedFloats)
            {
        ...
        {
            var chld:Object;
            var block:TableBlockContainer;
            var cells:Vector.<TableCellElement>;
            var cell:TableCellElement;
            point = point.clone();
        ...
        {
            var textLine:TextLine;
            var tbc:TableBlockContainer;
            var tfl:TextFlowLine;
            var tftb:TextFlowTableBlock;
            var index:int;
            for each (textLine in this._linesInView)
            {
        ...
        tlf_internal function addFloatAt(absolutePosition:int, _arg_2:DisplayObject, floatType:String, x:Number, y:Number, alpha:Number, matrix:Matrix, depth:Number, knockOutWidth:Number, columnIndex:int, parent:DisplayObjectContainer):void
        {
            var index:int;
            if (!this._composedFloats)
            {
            ...
            var floatInfo:FloatCompositionData = new FloatCompositionData(absolutePosition, _arg_2, floatType, x, y, alpha, matrix, depth, knockOutWidth, columnIndex, parent);
...
class PsuedoMouseEvent extends MouseEvent 
{
    ...
    public function PsuedoMouseEvent(_arg_1:String, bubbles:Boolean=true, cancelable:Boolean=false, localX:Number=NaN, localY:Number=NaN, relatedObject:InteractiveObject=null, ctrlKey:Boolean=false, altKey:Boolean=false, shiftKey:Boolean=false, buttonDown:Boolean=false)
    {
        super(_arg_1, bubbles, cancelable, localX, localY, relatedObject, ctrlKey, altKey, shiftKey, buttonDown);
    }
