package flashx.textLayout.utils
{
    ...
    public final class NavigationUtil 
    {
        ...
        tlf_internal static function computeEndIdx(targetFlowLine:TextFlowLine, curTextFlowLine:TextFlowLine, blockProgression:String, isRTLDirection:Boolean, globalPoint:Point):int
        {
            var endIdx:int;
            var atomIndex:int;
            var firstAtomRect:Rectangle;
            var firstAtomPoint:Point;
            var glyphRect:Rectangle;
            var leanRight:Boolean;
            var paraSelectionIdx:int;
            var glyphGlobalPoint:Point;
        ...
        {
            var curTextFlowLine:TextFlowLine;
            var lineStart:int;
            var lineDelta:int;
            var currentTextLine:TextLine;
            var blockOffset:int;
            var atomIndex:int;
            var bidiRightToLeft:Boolean;
            var curPosRect:Rectangle;
            var currentTextLineX:Number;
            var curPosRectLeft:Number;
            var curPosRectRight:Number;
            var globalPoint:Point;
            var lineInc:int;
            var nextFlowLine:TextFlowLine;
            var controller:ContainerController;
            var firstPosInContainer:int;
            var lastPosInContainer:int;
            var curLogicalHorizontalScrollPos:Number;
            if (!validateTextRange(range))
            {
                return (false);
            };
        ...
        public static function nextPage(range:TextRange, extendSelection:Boolean=false):Boolean
        {
            ...
            var oldHorzScrollPos:Number;
            var newHorzScrollPos:Number;
            var contentHeight:Number;
            var oldVertScrollPos:Number;
            var newVertScrollPos:Number;
            if (!validateTextRange(range))
            {
                return (false);
            };
        ...
        public static function previousPage(range:TextRange, extendSelection:Boolean=false):Boolean
        {
            var nextLine:int;
            var amount:Number;
            var oldHorzPos:Number;
            var newHorzPos:Number;
            var oldVertPos:Number;
            var newVertPos:Number;
            if (!validateTextRange(range))
            {
                return (false);
            };
