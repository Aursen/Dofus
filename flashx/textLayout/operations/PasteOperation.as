package flashx.textLayout.operations
{
    ...
    public class PasteOperation extends FlowTextOperation 
    {
        ...
        {
            var preserveScrapParagraph:Boolean;
            var plainText:Boolean;
            var nextInsertPosition:int;
        ...
        {
            var scrapEndParagraph:ParagraphElement;
            var applyEndParagraphFormat:ApplyFormatToElementOperation;
        ...
        override public function undo():SelectionState
        {
            ...
            if (this._textScrap != null)
            {
                ...
                {
                    i = (this._applyParagraphSettings.length - 1);
                    while (i >= 0)
                    {
