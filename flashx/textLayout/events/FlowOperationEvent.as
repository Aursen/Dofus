package flashx.textLayout.events
{
    ...
    public class FlowOperationEvent extends Event 
    {
        ...
        public function FlowOperationEvent(_arg_1:String, bubbles:Boolean=false, cancelable:Boolean=false, operation:FlowOperation=null, level:int=0, error:Error=null)
        {
            this._op = operation;
            this._e = error;
            this._level = level;
