package flashx.textLayout.events
{
    ...
    public class DamageEvent extends Event 
    {
        ...
        public function DamageEvent(_arg_1:String, bubbles:Boolean=false, cancelable:Boolean=false, textFlow:TextFlow=null, damageAbsoluteStart:int=0, damageLength:int=0)
        {
