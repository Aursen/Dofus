package flashx.textLayout.events
{
    ...
    public class CompositionCompleteEvent extends Event 
    {
        ...
        public function CompositionCompleteEvent(_arg_1:String, bubbles:Boolean=false, cancelable:Boolean=false, textFlow:TextFlow=null, compositionStart:int=0, compositionLength:int=0)
        {
