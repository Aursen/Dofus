package Ankama_Tooltips.makers
{
    ...
    public class ItemTooltipMaker implements ITooltipMaker 
    {
        ...
        public function createTooltip(data:*, param:Object):Object
        {
            ...
            var effect:*;
            var randomDropGroup:RandomDropGroup;
            var group:Array;
            var playerSetInfo:Object;
            var idol:Idol;
            var showTheoreticalEffectsTip:String;
            var leftText:String;
            ...
            if (((this._effects.length) && (_param.effects)))
            {
        ...
        {
            var randomDropItemInfo:Object;
            var randomItem:RandomDropItem;
            if (!randomDropGroup)
            {
                return (null);
            };
