package Ankama_Tooltips.ui
{
    ...
    public class TooltipPinableBaseUi 
    {
        ...
        private static const KEY_PIN:uint = Keyboard.ALTERNATE;//18
        ...
        public function main(params:Object=null):void
        {
            ...
            {
                if (tooltipName.indexOf("compare") == -1)
                {
        ...
        protected function makePin():void
        {
            ...
            if (!this.mainCtr)
            {
                ...
                this.dragControler.bgColor = 0xFF0000;
                ...
                else
                {
                    if (target == this.btnMenu)
                    {
                        if (((this._params) && (!(this._params.data == MountWrapper))))
                        {
                            ...
                            {
                                if (((this._params) && (this._params.data)))
                                {
