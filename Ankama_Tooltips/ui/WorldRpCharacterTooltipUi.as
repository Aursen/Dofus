package Ankama_Tooltips.ui
{
    ...
    public class WorldRpCharacterTooltipUi 
    {
        ...
        public static function showAlignmentWings(oParam:Object, instance:Object):void
        {
            ...
            if ((((alignmentInfos) && (alignmentInfos.alignmentSide > AlignementSideEnum.ALIGNMENT_NEUTRAL)) && (alignmentInfos.alignmentGrade > 0)))
            {
                w = int(((tx_back.width / 2) - 4));
                ...
                if (data.hasOwnProperty("wingsEffect"))
                {
                    ...
                    {
                        if (alignmentInfos.alignmentSide == AlignementSideEnum.ALIGNMENT_EVIL)
                        {
                    ...
                    else
                    {
                        if (data.wingsEffect == 1)
                        {
                            if (alignmentInfos.alignmentSide == AlignementSideEnum.ALIGNMENT_ANGEL)
                            {
            ...
            if (hasInfos)
            {
                ...
                if ((data.infos.humanoidInfo is HumanInformations))
                {
                    for each (option in (data.infos.humanoidInfo as HumanInformations).options)
                    {
                        ...
                        {
                            if (((option is HumanOptionAlliance) && ((!(data.hasOwnProperty("hideAlliance"))) || (!(data.hideAlliance)))))
                            {
        ...
        {
            var uiBounds:Object;
            var displayOmegaBottom:Boolean;
            var koliRankBounds:*;
            var bounds:*;
            var omegaBounds:*;
            ...
            switch (target)
            {
                ...
                case this.tx_ornament:
                    ...
                    if (this.tx_ornament.child)
                    {
                        ...
                        {
                            if (this.tx_ornament.child.hasOwnProperty("tx_kolizeum_rank"))
                            {
