package Ankama_Tooltips.ui
{
    ...
    public class CartographyTooltipUi 
    {
        ...
        private const _containers:Vector.<GraphicContainer> = new <GraphicContainer>[ctr_additionalInfo, ctr_subAreaInfo, ctr_alliance];
        ...
        {
            var topBlock:GraphicContainer;
            var topBlockBg:GraphicContainer;
            var emblemMiddle:Number;
            ...
            if (hasSubArea)
            {
                ...
                totalDaresInSubArea = (totalDaresInSubArea + this.socialApi.getTotalDaresInSubArea(pSubArea.id));
            };
            ...
            {
                this.lbl_subAreaDare.text = this.uiApi.processText(this.uiApi.getText("ui.social.dare.totalAvailable", totalDaresInSubArea), "", (totalDaresInSubArea == 1), (totalDaresInSubArea == 0));
                this.lbl_subAreaDare.fullWidthAndHeight();
        ...
        private function updateSize():void
        {
            ...
            var allianceWidth:Number = ((this.ctr_alliance.visible) ? ((this.lbl_allianceName.textWidth + 8) + 40) : 0);
