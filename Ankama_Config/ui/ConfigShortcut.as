package Ankama_Config.ui
{
    ...
    public class ConfigShortcut extends ConfigUi 
    {
        ...
        private var _categoryCheckboxStates:Dictionary = new Dictionary();
        private var _categoryCheckboxComponents:Dictionary = new Dictionary();
        private var _lblShortcutNames:Dictionary = new Dictionary(true);
        private var _buttonsList:Dictionary = new Dictionary();
        private var _bindsList:Dictionary = new Dictionary();
        private var _shortcutsList:Dictionary = new Dictionary();
        private var _savedData:Dictionary;
        private var _currentShortcut:Shortcut;
        private var _shortcutsCat:Dictionary = new Dictionary();
