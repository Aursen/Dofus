package Ankama_Config.ui
{
    ...
    public class ThemeInstaller 
    {
        ...
        public function onRelease(target:Object):void
        {
            ...
            var lastUsedUrls:*;
            var canAddUrlToHistory:Boolean;
            var lastUsedUrl:*;
                ...
                case this.btn_fetch:
                    ...
                    if (URL_REGEX.test(url))
                    {
                        ...
                        else
                        {
                            ...
                            this.sysApi.sendAction(new ThemeListRequest(url));
                        };
                    }
                    else
                    {
                        if (this.sysApi.getBuildType() == BuildTypeEnum.DEBUG)
                        {
                            ...
                            {
                                this.sysApi.sendAction(new ThemeListRequest(("file://" + url)));
                            };
                        };
                    };
                    break;
        ...
        public function startInstall(data:Object, update:Boolean=false):void
        {
            ...
            this.sysApi.sendAction(new ThemeInstallRequest(data.url));
        }
        ...
        public function startUninstall(data:Object):void
        {
            ...
            this.sysApi.sendAction(new ThemeDeleteRequest(((data.author + "_") + data.name)));
