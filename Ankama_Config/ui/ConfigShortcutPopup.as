package Ankama_Config.ui
{
    ...
    public class ConfigShortcutPopup 
    {
        ...
        private function onKeyboardShortcut(bind:Bind, keyCode:uint):void
        {
            ...
            {
                if ((((this._currentShortcut.textfieldEnabled) && ((!((this._currentShortcut as Shortcut).defaultBind)) || (!((this._currentShortcut as Shortcut).defaultBind.equals(bind))))) && (!((((bind.shift) && (bind.ctrl)) || ((bind.alt) && (!(bind.ctrl)))) || ((bind.ctrl) && (!(bind.alt)))))))
                {
                    switch (keyCode)
                    {
