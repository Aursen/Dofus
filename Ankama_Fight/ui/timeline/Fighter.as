package Ankama_Fight.ui.timeline
{
    ...
    public class Fighter 
    {
        ...
        public function setPdvThreshold(lifePointsThreshold:int):void
        {
            ...
            var currentHeartRatio:Number = (lifePointsThreshold / infos.maxLifePoints);
            if (lifePointsThreshold === 0)
            {
                result = 0;
        ...
        public function startCountDown(turnDuration:int, remainingTime:uint):void
        {
            ...
            this._timeMask.y = 0;
            var glow2:GlowFilter = new GlowFilter(0xFFFFFF, 0, 1, 1, 2, BitmapFilterQuality.HIGH);
        ...
        public function stopCountDown():void
        {
            ...
            var glow:GlowFilter = new GlowFilter(0xFFFFFF, 0.2, 20, 20, 2, BitmapFilterQuality.HIGH);
        ...
        private function displayFighter(id:Number, num:uint):void
        {
            ...
            this._gfxMask.graphics.beginFill(0xFF5500);
        ...
        private function createFrame(summoned:Boolean):ButtonContainer
        {
            ...
            else
            {
                ...
                this._timeMask.graphics.beginFill(0xFF5500);
        ...
        private function setAlive(alive:Boolean):void
        {
            ...
            if (this._alive)
            {
                ...
                glow = new GlowFilter(0xFFFFFF, 0.2, 20, 20, 2, BitmapFilterQuality.HIGH);
                this._gfx.filters = [glow];
            }
            else
            {
