package Ankama_Fight
{
    ...
    import d2hooks.OpenFightResults;
    ...
    import d2actions.ToggleEntityIcons;
    ...
    public class Fight extends Sprite 
    {
        ...
        public static var resultsRecap:Object;
        ...
        public function main():void
        {
            ...
            this.sysApi.addHook(OpenFightResults, this.onOpenFightResults);
        ...
        public function onShortcut(shortcut:String):Boolean
        {
            ...
            {
                this.sysApi.sendAction(new ToggleEntityIcons((!(this.sysApi.getOption("toggleEntityIcons", "dofus")))));
                return (true);
            };
            return (false);
        }
        ...
        private function onGameFightEnd(params:Object):void
        {
            ...
            this.onOpenFightResults(params);
            if (this.uiApi.getUi("turnStart"))
            {
                this.uiApi.unloadUi("turnStart");
            };
        ...
        private function onOpenFightResults(pResultsRecap:Object):void
        {
            var useFightResultSimple:Boolean;
            if (!pResultsRecap)
            {
                pResultsRecap = resultsRecap;
            };
            if (pResultsRecap.results.length > 0)
            {
                ...
                {
                    if (this.uiApi.getUi("fightResult"))
                    {
        ...
        private function onOpenBuffs(targetId:Number):void
        {
            ...
            {
                if (this._currentBuffsOwnerId == targetId)
                {
                    this.uiApi.unloadUi("buffs");
                }
                else
        ...
        {
            this.sysApi.sendAction(new GameFightPlacementSwapPositionsAccept(pRequestId));
        }

        private function onRefuse(pRequestId:uint):void
        {
            this.sysApi.sendAction(new GameFightPlacementSwapPositionsCancel(pRequestId));
        }
