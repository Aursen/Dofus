package Ankama_CharacterSheet.ui
{
    ...
    public class StatBoost 
    {
        ...
        {
            var pointsY:int;
            var calculationY:int;
            var footerY:int;
            var characterSheetUiRect:Object;
        ...
        public function onRollOver(target:Object):void
        {
            ...
            else
            {
                ...
                {
                    if (target == this.lbl_statBonus)
                    {
                        text = this.uiApi.getText("ui.stats.bonuses");
                    }
                    else
                    {
                        if (((!(target.customUnicName.indexOf("lbl_variable") == -1)) && (this._statVariableAssoc[target])))
                        {
...
class StatVariable 
{
    ...
    public function StatVariable(pGfxId:String, pText:String)
    {
        this.gfxId = pGfxId;
        this.text = pText;
    }
