package Ankama_Connection.ui
{
    ...
    import d2hooks.CharacterCanBeCreated;
    ...
    public class CharacterSelection 
    {
        ...
        public function main(charaList:Object):void
        {
            ...
            this.sysApi.addHook(CharacterCanBeCreated, this.onCharacterCanBeCreated);
        ...
        public function onRelease(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.btn_create:
                    ...
                    {
                        if ((((!(this.sysApi.getPlayerManager().canCreateNewCharacter)) && (this.sysApi.isCharacterCreationAllowed())) && (!(this.sysApi.getCurrentServer().gameTypeId == GameServerTypeEnum.SERVER_TYPE_TEMPORIS))))
                        {
        ...
        public function onCharactersListUpdated(charactersList:Object):void
        {
            ...
            {
                bonus = ((bonusXpCreation > 3) ? 3 : bonusXpCreation);
                if (bonus == 0)
                {
        ...
        public function onRollOver(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                default:
                    ...
                    {
                        if (target.name.indexOf("btn_gridCharacter") != -1)
                        {
