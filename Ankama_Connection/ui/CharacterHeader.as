    ...
    public class CharacterHeader 
    {
        ...
        public function showHeader(b:Boolean):void
        {
            ...
            if (b)
            {
                ...
                {
                    if (this._currentUi == "characterSelection")
                    {
                        this.ctr_cbMode.visible = false;
        ...
        {
            var text:String;
            var availableSlotsByServerType:Array;
        ...
        public function onPopupConnection():void
        {
            ...
            if (chosenServer)
            {
                ...
                this.sysApi.sendAction(new ChangeCharacter(chosenServer.id));
            }
            else
            {
