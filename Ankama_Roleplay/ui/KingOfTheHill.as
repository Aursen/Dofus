package Ankama_Roleplay.ui
{
    ...
    public class KingOfTheHill 
    {
        ...
        private var _alliances:Array = new Array();
        ...
        private var _bar:Dictionary = new Dictionary();
        private var _barCtr:Dictionary = new Dictionary();
        private var _closeTimer:Timer = new Timer(TIME_UNLOAD_AFTER_END);
        ...
        private function updateTheHill():void
        {
            ...
            for each (alliance in this._alliances)
            {
                ...
                {
                    width = int(Math.max(1, Math.floor((((this._barWidth - this._alliances.length) + 1) / this._alliances.length))));
                }
                else
                {
        ...
        private function onKohUpdate(alliances:Vector.<AllianceOnTheHillWrapper>, allianceMapWinners:Vector.<BasicAllianceInformations>, allianceMapWinnerScore:uint, allianceMapMyAllianceScore:uint, nextTickTime:Number):void
        {
            ...
            var conquestText:String;
            var ts:Number;
            var allianceWinnerInfo:BasicAllianceInformations;
            ...
            {
                if (allianceMapWinners.length > 1)
                {
