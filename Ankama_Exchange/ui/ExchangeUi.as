package Ankama_Exchange.ui
{
    ...
    public class ExchangeUi 
    {
        ...
        private var _myTopTimer:Timer = new Timer(250, 12);
        private var _myBottomTimer:Timer = new Timer(250, 12);
        private var _redTop:Boolean;
        private var _redBottom:Boolean;
        private var _myPodsTimer:Timer = new Timer(250, 12);
        ...
        public function main(oParam:Object=null):void
        {
            ...
            this.tx_kamaRight.alpha = ((this.playerApi.hasDebt()) ? 0.4 : 1);
            ...
            charMaskL.graphics.beginFill(0xFF5500, 0.5);
            ...
            charMaskR.graphics.beginFill(0xFF5500, 0.5);
        ...
        private function updateEstimatedValue(pItemsList:Array, pKamas:Number, pLabel:Label):void
        {
            ...
            {
                if (pLabel.name == "lbl_estimated_value_right")
                {
