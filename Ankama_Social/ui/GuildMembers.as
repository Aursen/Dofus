    ...
    public class GuildMembers 
    {
        ...
        public function updateGuildMemberLine(data:*, components:*, selected:Boolean):void
        {
            ...
            if (data != null)
            {
                ...
                {
                    if (memberInfo.connected == PlayerStateEnum.GAME_TYPE_ROLEPLAY)
                    {
                    ...
                    {
                        if (memberInfo.connected == PlayerStateEnum.GAME_TYPE_FIGHT)
                        {
                            components.lbl_playerName.text = (((((("{player," + memberInfo.name) + ",") + memberInfo.id) + "::") + memberInfo.name) + "}");
                        ...
                        {
                            if (memberInfo.connected == PlayerStateEnum.UNKNOWN_STATE)
                            {
                                components.lbl_playerName.text = memberInfo.name;
                                components.tx_state.uri = null;
                            }
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            if ((((!(target.name.indexOf("tx_state") == -1)) || (!(target.name.indexOf("tx_mood") == -1))) || (!(target.name.indexOf("tx_fight") == -1))))
                                                            {
                                                                ...
                                                                {
                                                                    this.sysApi.sendAction(new GameFightSpectatePlayerRequest(data.id));
                                                                };
                                                            }
                                                            else
                                                            {
                                                                ...
                                                                {
                                                                    data = this._interactiveComponentsList[target.name];
                                                                    this.sysApi.sendAction(new HavenbagEnter(data.id));
                                                                };
                                                            };
                                                        };
                                                    };
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (target.name.indexOf("lbl_playerName") != -1)
                            {
                                ...
                                {
                                    months = int(Math.floor((memberInfo.hoursSinceLastConnection / 720)));
                                    days = int(((memberInfo.hoursSinceLastConnection - (months * 720)) / 24));
                                    if (months > 0)
                                    {
                                        if (days > 0)
                                        {
                            ...
                            {
                                if (target.name.indexOf("tx_lvl") != -1)
                                {
