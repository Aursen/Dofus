package Ankama_Social.ui
{
    ...
    public class SocialBulletin 
    {
        ...
        public function main(... args):void
        {
            ...
            {
                if (((this._currentSocialGroup == GUILD) && (this.socialApi.hasGuildRank(this._playerId, 2))))
                {
                    this.btn_edit.visible = true;
                }
                else
                ...
                else
                {
                    if (target == this.btn_valid)
                    {
                        if (this.inp_bulletin.text != this._socialGroupData.bulletin)
                        {
                            ...
                            if (this._currentSocialGroup == GUILD)
                            {
                                this.sysApi.sendAction(new GuildBulletinSetRequest(this.inp_bulletin.text, notifyMembers));
                            }
                            else
                            {
                                if (this._currentSocialGroup == ALLIANCE)
                                {
                                    this.sysApi.sendAction(new AllianceBulletinSetRequest(this.inp_bulletin.text, notifyMembers));
                                };
                            };
                        }
                        else
