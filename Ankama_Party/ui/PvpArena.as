package Ankama_Party.ui
{
    ...
    public class PvpArena 
    {
        ...
        {
            var partyMembersBreedId:Dictionary;
            var fighter:PartyMemberWrapper;
        ...
        public function onRelease(target:Object):void
        {
            switch (target)
            {
                case this.btn_3v3TeamQueue:
                    ...
                    {
                        this.sysApi.sendAction(new ArenaRegister(PvpArenaTypeEnum.ARENA_TYPE_3VS3_TEAM, false));
                ...
                case this.btn_3v3SoloQueue:
                    if (!this._isRegistered)
                    {
                        this.sysApi.sendAction(new ArenaRegister(PvpArenaTypeEnum.ARENA_TYPE_3VS3_SOLO, false));
                ...
                case this.btn_1v1Queue:
                    if (!this._isRegistered)
                    {
                        this.sysApi.sendAction(new ArenaRegister(PvpArenaTypeEnum.ARENA_TYPE_1VS1, false));
        ...
        {
            var data:Object;
            var resetHours:String;
            var resetMinutes:String;
            var teamCount:int;
            switch (target)
            {
        ...
        public function onShortcut(s:String):Boolean
        {
            switch (s)
            {
                case "validUi":
                    if (!this._isRegistered)
                    {
                        this.sysApi.sendAction(new ArenaRegister(this._currentFightMode, true));
                    };
                    return (true);
                case "closeUi":
                    this.uiApi.unloadUi(this.uiApi.me().name);
        ...
        public function onArenaRegistrationStatusUpdate(isRegistered:Boolean, currentStatus:int):void
        {
            ...
            switch (this._currentStatus)
            {
                ...
                case PvpArenaStepEnum.ARENA_STEP_REGISTRED:
                    ...
                    {
                        if (this._currentFightMode == PvpArenaTypeEnum.ARENA_TYPE_3VS3_SOLO)
                        {
                            this.btn_1v1Queue.softDisabled = true;
                            this.btn_3v3SoloQueue.softDisabled = false;
                            this.btn_3v3TeamQueue.softDisabled = true;
