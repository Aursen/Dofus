package 
{
    ...
    public class DofusClientMain extends Sprite implements IDofus 
    {
        ...
        public function DofusClientMain()
        {
            ...
            var version:Array;
            super();
            var buildType:String = String("beta").replace(/[0-9]/g, "");
            BuildInfos.VERSION = new Version("2.56.5-beta", ((buildType.toUpperCase() == "LOCAL") ? BuildTypeEnum.INTERNAL : (BuildTypeEnum[buildType.toUpperCase()])));
            BuildInfos.BUILD_DATE = "10-07-2020 13:02";
            try
            {
            ...
            URLRequestDefaults.idleTimeout = (((BuildInfos.BUILD_TYPE == BuildTypeEnum.INTERNAL) || (BuildInfos.BUILD_TYPE == BuildTypeEnum.DEBUG)) ? this.REQUEST_TIMEOUT_LOCAL : this.REQUEST_TIMEOUT);
        ...
        private function onKeyDown(e:KeyboardEvent):void
        {
            ...
            {
                if (((e.altKey) && (String.fromCharCode(e.charCode) == "²")))
                {
        ...
        public function setDisplayOptions(opt:DofusOptions):void
        {
            ...
            {
                if (this._doOptions.getOption("forceRenderCPU") != AppIdModifier.getInstance().forceCPURenderMode)
                {
        ...
        private function sendUiStats():void
        {
            ...
            var benchmarkResultsList:Array;
            var res:String;
            var resList:Array;
            var uiData:Object;
            var key:String;
