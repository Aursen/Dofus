package com.ankamagames.atouin
{
    ...
    public class AtouinConstants 
    {
        ...
        public static const RESOLUTION_HIGH_QUALITY:Point = new Point(1978, 0x0400);
        public static const RESOLUTION_MEDIUM_QUALITY:Point = new Point(1483.5, 0x0300);
        public static const RESOLUTION_LOW_QUALITY:Point = new Point(989, 0x0200);
