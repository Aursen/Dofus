package com.ankamagames.atouin.renderers
{
    ...
    public class MapRenderer extends EventDispatcher 
    {
        ...
        private var _swfApplicationDomain:Array = new Array();
        private var _dataMapContainer:DataMapContainer;
        private var _icm:InteractiveCellManager;
        private var _hideForeground:Boolean = Atouin.getInstance().options.getOption("hideForeground");
        ...
        private var _downloadTimer:Timer = new Timer(2500);
        ...
        private var _srcRect:Rectangle = new Rectangle();
        private var _destPoint:Point = new Point();
        private var _cellBitmapData:BitmapData;
        private var _clTrans:ColorTransform = new ColorTransform();
            ...
            for each (nged in gfxList)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (((!(isJpg)) && (this._gfxPathPngOverride)))
                            {
        ...
        public function isCellUnderFixture(pCellId:uint):Boolean
        {
            ...
            return ((this._foregroundBitmap) && (this._foregroundBitmap.bitmapData.hitTest(new Point(this._foregroundBitmap.x, this._foregroundBitmap.y), 0xFF, new Rectangle(cellRef.x, cellRef.y, AtouinConstants.CELL_WIDTH, AtouinConstants.CELL_HEIGHT))));
        }
        ...
        public function setRenderScale(scale:int):Boolean
        {
            if (((this._gfxPathSwf) && (!(this._gfxPathSwf.charAt(0) == "!"))))
            {
                ...
                {
                    if (this._previousGroundCacheMode != -1)
                    {
        ...
        private function makeMap():void
        {
            ...
            var currentLayerIsGround:Boolean;
            var i:uint;
            var nbCell:uint;
            var cell:Cell;
            ...
            var cellElevation:int;
            var t:ColorTransform;
            var finalGroundBitmapData:BitmapData;
            var finalGroundBitmap:Bitmap;
            var tsJpeg:uint;
                ...
                else
                {
                    ...
                    while (i < nbCell)
                    {
                        ...
                        if (((!(layerId == Layer.LAYER_ADDITIONAL_DECOR)) && (!(aInteractiveCell[currentCellId]))))
                        {
                            ...
                            cellElevation = ((this._tacticModeActivated) ? 0 : cellData.floor);
                    ...
                    else
                    {
                        if (!this._hasGroundJPG)
                        {
                            finalGroundBitmapData = new BitmapData((AtouinConstants.RESOLUTION_HIGH_QUALITY.x * this._renderScale), (AtouinConstants.RESOLUTION_HIGH_QUALITY.y * this._renderScale), (!(this._renderBackgroundColor)), ((this._renderBackgroundColor) ? this._map.backgroundColor : 0));
                            this._m.identity();
        ...
        {
            var bitmapFinalWidth:uint;
            var bitmapFinalHeight:uint;
            var groundBitmapData:BitmapData;
            ...
            var bitmapBackgroundColor:uint = ((this._renderBackgroundColor) ? this._map.backgroundColor : 0);
            try
            {
        ...
        {
            var foregroundBitmapData:BitmapData;
            try
            {
            ...
            for (;i < nbElements;(i = (i + 1)))
            {
                ...
                else
                {
                    if (element.elementType != ElementTypesEnum.SOUND)
                    {
                        ...
                        {
                            this._cellBitmapData = new BitmapData(AtouinConstants.CELL_WIDTH, AtouinConstants.CELL_HEIGHT, false, 0xCC00CC);
                            shape = new Shape();
        ...
        private function onBitmapGfxLoaded(e:ResourceLoadedEvent):void
        {
            ...
            {
                if ((e.resource.content is MovieClip))
                {
