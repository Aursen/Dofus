package com.ankamagames.dofus.internalDatacenter.items
{
    ...
    public class BuildWrapper extends ItemWrapper implements IDataCenter 
    {
        ...
        {
            var carac:CharacterCharacteristicForPreset;
            var playerInventory:Vector.<ItemWrapper>;
            var inventoryItem:ItemWrapper;
            var itemForPreset:ItemForPreset;
            var itemFoundInInventory:Boolean;
            var cloneItem:ItemWrapper;
            var item:ItemWrapper;
            var sfp:SpellForPreset;
            this.statsByKeyword = new Dictionary();
            var presetlogs:String = "";
