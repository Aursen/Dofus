package com.ankamagames.dofus.internalDatacenter.house
{
    ...
    public class HavenbagFurnitureWrapper extends HavenbagFurniture implements IDataCenter, ICustomSlotData 
    {
        ...
        {
            var furniture:HavenbagFurnitureWrapper;
            var refFurniture:HavenbagFurniture;
        ...
        public function get colorTransform():ColorTransform
        {
            ...
            if (((!(color == int.MAX_VALUE)) && (!(this._colorTransform))))
            {
                ...
                g = ((color & 0xFF00) >> 8);
                b = (color & 0xFF);
                this._colorTransform = new ColorTransform((ColorMultiplicator.clamp((r * 2), 0, 0x0200) / 0xFF), (ColorMultiplicator.clamp((g * 2), 0, 0x0200) / 0xFF), (ColorMultiplicator.clamp((b * 2), 0, 0x0200) / 0xFF));
            };
