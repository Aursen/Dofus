package com.ankamagames.dofus.uiApi
{
    ...
    public class AbstractItemFilterApi implements IApi 
    {
        ...
        public function filterIsSelected(data:Object):Boolean
        {
            ...
            if ((((((((!(this._currentItemFilter.currentCharacIds.indexOf(data.cId) == -1)) && (!(data.id == "subCategory"))) && (!(data.id == "weaponEffect"))) && (!(data.id == "consumableEffect"))) && (!(data.id == "obtaining"))) && (!(data.id == "targetWeapon"))) && (!(data.id == "targetEquipment"))))
            {
                return (true);
            };
            return (false);
