package com.ankamagames.dofus.logic.game.fight.steps
{
    ...
    public class FightSummonStep extends AbstractSequencable implements IFightStep 
    {
        ...
        {
            var gfsgmsg:GameFightShowFighterMessage;
            var buffs:Array;
            var buff:BasicBuff;
            ...
            if (this._summonInfos.contextualId == PlayedCharacterManager.getInstance().id)
            {
                ...
                fighterInfos.stats.lifePoints = ((this._summonInfos.stats.lifePoints == 0) ? uint((this._summonInfos.stats.maxLifePoints / 2)) : this._summonInfos.stats.lifePoints);
            ...
            {
                if (this._summonInfos.stats.lifePoints == 0)
                {
