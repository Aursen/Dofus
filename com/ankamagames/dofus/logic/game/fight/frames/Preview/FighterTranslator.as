package com.ankamagames.dofus.logic.game.fight.frames.Preview
{
    ...
    public class FighterTranslator extends HaxeFighter 
    {
        ...
        override public function getModelId():uint
        {
            ...
            return ((gameFightEntityInfo == null) ? 0 : gameFightEntityInfo.entityModelId);
        }
            ...
            for each (buff in BuffManager.getInstance().getAllBuff(fighterId))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (((buff.effect.delay == 0) && ((!(buff is StateBuff)) || (FightersStateManager.getInstance().hasState(fighterId, (buff as StateBuff).stateId)))))
                            {
        ...
        {
            var monsterInfo:GameFightMonsterInformations;
