package com.ankamagames.dofus.logic.game.fight.frames.Preview
{
    ...
    public class FighterDataTranslator implements IFighterData 
    {
        ...
        protected var itemSpellDamageModificator:Dictionary = new Dictionary();
        protected var itemSpellBaseDamageModificator:Dictionary = new Dictionary();
