package com.ankamagames.dofus.logic.game.fight.types
{
    ...
    public class SwapPositionRequest 
    {
        ...
        {
            var entity:AnimatedCharacter = (DofusEntities.getEntity(((this._isRequesterIcon) ? this.requesterId : this.requestedId)) as AnimatedCharacter);
        ...
        {
            var entityId:Number = ((this._isRequesterIcon) ? this.requesterId : this.requestedId);
        ...
        private function placeIcon(pEntity:AnimatedCharacter):void
        {
            ...
            if (targetBounds)
            {
                offsetY = ((TooltipManager.isVisible(("tooltipOverEntity_" + pEntity.id))) ? 70 : 10);
