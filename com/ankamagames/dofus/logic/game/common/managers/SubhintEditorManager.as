package com.ankamagames.dofus.logic.game.common.managers
{
    ...
    public class SubhintEditorManager 
    {
        ...
        private var _log:Logger = Log.getLogger(getQualifiedClassName(SubhintEditorManager));
        private var _loader:URLLoader;
        private var _request:URLRequest;
        private var _baseURL:String = "http://docker-dofus:8081/dofus/hints/";
        private var _hintToDelete:Object = new Object();
        ...
        private function updateHintsAfterOperation():void
        {
            ...
            var minOrder:int;
            var maxOrder:int;
            var putOrderChanged:Boolean;
            var shw:SubhintWrapper;
            var parentChanged:Boolean;
            var previousParentOrder:int;
            ...
            switch (this._operation)
            {
                case "modify":
                    ...
                    if (((putOrderChanged) || (parentChanged)))
                    {
                        ...
                        {
                            if (subhintWrapper.hint_order == (subhintDictionary[subhintWrapper.hint_parent_uid].length - 1))
                            {
