package com.ankamagames.dofus.logic.game.common.misc.inventoryView
{
    ...
    public class StorageSmithMagicFilterView extends StorageGenericView 
    {
        ...
        private var _listeningItemTypes:Array = [DataEnum.ITEM_TYPE_SMITHMAGIC_RUNE, DataEnum.ITEM_TYPE_SMITHMAGIC_POTION, DataEnum.ITEM_TYPE_SMITHMAGIC_ORB, DataEnum.ITEM_TYPE_SMITHMAGIC_TRANSCENDANCE_RUNE, DataEnum.ITEM_TYPE_SMITHMAGIC_CORRUPTION_RUNE];
