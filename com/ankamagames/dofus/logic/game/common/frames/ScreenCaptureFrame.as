package com.ankamagames.dofus.logic.game.common.frames
{
    ...
    public class ScreenCaptureFrame implements Frame 
    {
        ...
        private var _screenshotsChecksums:Dictionary = new Dictionary();
        ...
        {
            var b:Bind;
            var captureScreenShortcutKey:String;
            var captureScreenWithoutUiShortcutKey:String;
            var notifId:uint;
        ...
        private function captureScreen(pWithoutUserInterfaces:Boolean=false):void
        {
            ...
            var name:*;
            var adminUiVisible:Boolean;
            var visibleUis:Vector.<String>;
