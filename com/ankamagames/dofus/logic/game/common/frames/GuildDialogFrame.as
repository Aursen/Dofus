package com.ankamagames.dofus.logic.game.common.frames
{
    ...
    public class GuildDialogFrame implements Frame 
    {
        ...
        {
            var gcva:GuildCreationValidAction;
            var gcvmsg:GuildCreationValidMessage;
            var gmva:GuildModificationValidAction;
            var gmvmsg:GuildModificationValidMessage;
            var gmnva:GuildModificationNameValidAction;
            var gmnvmsg:GuildModificationNameValidMessage;
            var gmeva:GuildModificationEmblemValidAction;
            var gmevmsg:GuildModificationEmblemValidMessage;
            var giaa:GuildInvitationAnswerAction;
            var giamsg:GuildInvitationAnswerMessage;
