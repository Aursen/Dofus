package com.ankamagames.dofus.logic.game.common.frames
{
    ...
    public class CommonUiFrame implements Frame 
    {
        ...
        public function process(msg:Message):Boolean
        {
            ...
            var oma:OpenMapAction;
            var oia:OpenInventoryAction;
            var cia:CloseInventoryAction;
            var cm:CinematicMessage;
            var dsmdmsg:DelayedSystemMessageDisplayMessage;
            var smdmsg:SystemMessageDisplayMessage;
            var cuiobomsg:ClientUIOpenedByObjectMessage;
            var cuiomsg:ClientUIOpenedMessage;
            ...
            var text:String;
            var payZonePopupMode:String;
            var szmsg:SubscriptionZoneMessage;
            var glmsg:GuestLimitationMessage;
            var textGuest:String;
            var gmmsg:GuestModeMessage;
            ...
            switch (true)
            {
                ...
                case (msg is EntityTalkMessage):
                    ...
                    params = new Array();
                    _local_20 = TextInformationTypeEnum.TEXT_ENTITY_TALK;
                    ...
                    if (InfoMessage.getInfoMessageById(((_local_20 * 10000) + etmsg.textId)))
                    {
                        textId2 = InfoMessage.getInfoMessageById(((_local_20 * 10000) + etmsg.textId)).textId;
                        if (param != null)
                        {
                    ...
                    {
                        _log.error((("Texte " + ((_local_20 * 10000) + etmsg.textId)) + " not found."));
