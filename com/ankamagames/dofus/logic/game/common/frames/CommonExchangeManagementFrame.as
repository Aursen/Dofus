package com.ankamagames.dofus.logic.game.common.frames
{
    ...
    public class CommonExchangeManagementFrame implements Frame 
    {
        ...
        public function process(msg:Message):Boolean
        {
            ...
            var bidhouseManagementFrame:BidHouseManagementFrame;
            var exchangeAcceptMessage:ExchangeAcceptMessage;
            var ldrmsg2:LeaveDialogRequestMessage;
            var era:ExchangeReadyAction;
            var ermsg:ExchangeReadyMessage;
            var erca:ExchangeReadyCrushAction;
            var fermsg:FocusedExchangeReadyMessage;
            var eommsg:ExchangeObjectModifiedMessage;
            var iwModified:ItemWrapper;
            var eosmmsg:ExchangeObjectsModifiedMessage;
            var itemModifiedArray:Array;
            var eoamsg:ExchangeObjectAddedMessage;
            var iwAdded:ItemWrapper;
            var eosamsg:ExchangeObjectsAddedMessage;
            var itemAddedArray:Array;
            var eormsg:ExchangeObjectRemovedMessage;
            var eosrmsg:ExchangeObjectsRemovedMessage;
            var itemDeleteMessage:Array;
            var itemUid:uint;
            var eoma:ExchangeObjectMoveAction;
            var iw:ItemWrapper;
            var eomvmsg:ExchangeObjectMoveMessage;
            var eirmsg:ExchangeIsReadyMessage;
            var roleplayEntitiesFrame:RoleplayEntitiesFrame;
            var playerName:String;
            var ekmmsg:ExchangeKamaModifiedMessage;
            var epmmsg:ExchangePodsModifiedMessage;
