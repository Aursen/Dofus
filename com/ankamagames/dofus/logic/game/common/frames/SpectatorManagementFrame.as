package com.ankamagames.dofus.logic.game.common.frames
{
    ...
    public class SpectatorManagementFrame implements Frame 
    {
        ...
        {
            var mrflrmsg:MapRunningFightListRequestMessage;
            var mrflmsg:MapRunningFightListMessage;
            var fights:Vector.<FightExternalInformations>;
            var mrfdra:MapRunningFightDetailsRequestAction;
            var mrfdrmsg:MapRunningFightDetailsRequestMessage;
            var stlrfmsg:StopToListenRunningFightRequestMessage;
            var mrfdemsg:MapRunningFightDetailsExtendedMessage;
            var attackersName:String;
            var defendersName:String;
            var mrfdmsg:MapRunningFightDetailsMessage;
            var jasra:JoinAsSpectatorRequestAction;
            var gfjrmsg:GameFightJoinRequestMessage;
            var jfra:JoinFightRequestAction;
            var gfspra:GameFightSpectatePlayerRequestAction;
            var gfsprmsg:GameFightSpectatePlayerRequestMessage;
