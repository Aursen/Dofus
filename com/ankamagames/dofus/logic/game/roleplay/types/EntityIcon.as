package com.ankamagames.dofus.logic.game.roleplay.types
{
    ...
    public class EntityIcon extends Sprite 
    {
        ...
        {
            var ctr_turnRemaining:GraphicContainer;
            var tx_turnRemaining:Texture;
            var tl_turnRemaining:Label;
            ...
            if (turnRemaining > 0)
            {
                ...
                ctr_turnRemaining.borderColor = 0xFF00FF;
        ...
        {
            var iconName:String;
            var iconsBounds:Rectangle;
            var icon:Texture;
            var iconBounds:Rectangle;
            var iconMaxX:Number;
            var iconMaxY:Number;
