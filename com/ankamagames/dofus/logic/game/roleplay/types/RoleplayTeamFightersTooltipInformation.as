package com.ankamagames.dofus.logic.game.roleplay.types
{
    ...
    public class RoleplayTeamFightersTooltipInformation 
    {
        ...
        public function RoleplayTeamFightersTooltipInformation(pFightTeam:FightTeam)
        {
            ...
            var monster:Monster;
            var monsterLevel:uint;
            var monsterName:String;
            var taxCollectorLevel:uint;
            var firstName:String;
            var lastName:String;
            var taxCollectorName:String;
            var companionInfo:FightTeamMemberEntityInformation;
            super();
...
class Fighter 
{
    ...
    public function Fighter(pId:Number, pName:String, pLevel:uint, pAllianceTagName:String=null)
    {
        this._id = pId;
        this.name = pName;
        this.level = pLevel;
