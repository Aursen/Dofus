package com.ankamagames.dofus.logic.game.roleplay.frames
{
    ...
    public class HavenbagFrame implements Frame 
    {
        ...
        public function HavenbagFrame(currentRoomId:uint, currentRoomThemeId:int, ownerInfos:CharacterMinimalInformations):void
        {
        ...
        {
            var furniture:HavenbagFurnitureSprite;
            var hema:HavenbagEditModeAction;
            var hbfmsg:HavenBagFurnituresMessage;
            var furnitureSprites:Array;
            var packedFurnitures:HavenbagPackedInfos;
            var ohbfsrmsg:OpenHavenBagFurnitureSequenceRequestMessage;
            var chbfsrmsg:CloseHavenBagFurnitureSequenceRequestMessage;
            var hfsa:HavenbagFurnitureSelectedAction;
            var mcmsg:MouseClickMessage;
            var clickedFurniture:IFurniture;
            var mrumsg:MouseRightUpMessage;
            var momsg:MouseOverMessage;
            var htsa:HavenbagThemeSelectedAction;
            var ctrmsg:ChangeThemeRequestMessage;
            var hrsa:HavenbagRoomSelectedAction;
            var chbrrmsg:ChangeHavenBagRoomRequestMessage;
            var hbpumsg:HavenBagPermissionsUpdateMessage;
            var hpura:HavenbagPermissionsUpdateRequestAction;
            var hbpurmsg:HavenBagPermissionsUpdateRequestMessage;
            var exithbrmsg:ExitHavenBagRequestMessage;
            var ewmsg:ExchangeWeightMessage;
            var hbdlmsg:HavenBagDailyLoteryMessage;
            var ehbrmsg:EditHavenBagRequestMessage;
            var ehbcrmsg:EditHavenBagCancelRequestMessage;
            var j:int;
            var f:HavenbagFurnitureSprite;
            var k:int;
            var hfrmsg:HavenBagFurnituresRequestMessage;
            var ehbcrmsg2:EditHavenBagCancelRequestMessage;
            var errorMsgId:String;
            switch (true)
            {
                ...
                case (msg is HavenBagFurnituresMessage):
                    ...
                    j = 0;
                    while (j < this._totalFurnituresToBeDisplayed)
                    {
                ...
                case (msg is HavenbagSaveAction):
                    ...
                    k = 0;
                    while (k < packedFurnitures.furnitureCellIds.length)
                    {
                        ...
                        k = (k + ProtocolConstantsEnum.MAX_FURNITURES_PER_PACKET);
                    };
        ...
        private function restoreFurnitures(furnituresInfo:HavenbagPackedInfos):void
        {
            ...
            HavenbagFurnituresManager.getInstance().removeAllFurnitures();
            var i:int;
            while (i < furnituresInfo.furnitureTypeIds.length)
            {
