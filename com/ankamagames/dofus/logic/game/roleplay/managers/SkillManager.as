package com.ankamagames.dofus.logic.game.roleplay.managers
{
    ...
    public class SkillManager 
    {
        ...
        public function prepareContextualMenu(skills:Array, ie:Object):Object
        {
            ...
            var skillIndex:int;
            var tpSkillIndex:int;
            var skill:Object;
            var skillApplyOnSeveralInstances:Boolean;
            var knownJob:KnownJobWrapper;
            var currentJobLevel:int;
            ...
            for each (disabledSkill in ie.element.disabledSkills)
            {
                ...
                else
                {
                    ...
                    if (skillDisabledData.parentJobId != 1)
                    {
                        ...
                        {
                            if (((skillDisabledData.levelMin > ProtocolConstantsEnum.MAX_JOB_LEVEL_NONSUBSCRIBER) && (PlayerManager.getInstance().isBasicAccount())))
                            {
