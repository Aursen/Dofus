package com.ankamagames.dofus.logic.common.managers
{
    ...
    public class FeatureManager 
    {
        ...
        public function FeatureManager():void
        {
        ...
        public function resetEnabledServerFeatures():void
        {
            ...
            var index:uint;
            while (index < (this._enabledFeatureIds.length - 1))
            {
        ...
        public function resetEnabledServerConnectionFeatures():void
        {
            ...
            while (index < (this._enabledFeatureIds.length - 1))
            {
                ...
                {
                    if ((((feature.isClient) && (!(feature.isServer))) && (feature.isActivationOnServerConnection)))
                    {
                        this.disableFeature(feature);
                    }
                    else
        ...
        {
            var optionalFeature:OptionalFeature;
