package com.ankamagames.dofus.logic.common.managers
{
    ...
    public class HyperlinkShowMonsterGroup 
    {
        ...
        {
            KernelEventsManager.getInstance().processCallback(HookList.AddMapFlag, ((((((("flag_chat_" + pX) + "_") + pY) + "_") + pMonsterName) + "_") + pGroupInfos.split(";")[0]), (((((unescape(pMonsterName) + " (") + pX) + ",") + pY) + ")"), pWorldMapId, pX, pY, 0xFF6600, true, false, true, true);
        }
