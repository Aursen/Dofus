package com.ankamagames.dofus.console.debug
{
    ...
    public class FontInstructionHandler implements ConsoleInstructionHandler 
    {
        ...
        private var length:int = characters.length;
        ...
        {
            var _local_2:String = this.characters.substr((10 * Timer(event.target).currentCount), 10);
            var ccmm:ChatClientMultiMessage = new ChatClientMultiMessage();
            ccmm.initChatAbstractClientMessage(_local_2);
