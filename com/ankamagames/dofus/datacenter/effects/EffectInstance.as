package com.ankamagames.dofus.datacenter.effects
{
    ...
    public class EffectInstance implements IDataCenter 
    {
        ...
        private function prepareDescription(desc:String, effectId:uint, forTooltip:Boolean=false, _arg_4:Boolean=false):String
        {
            var aTmp:Array;
            ...
            var lang:String;
            var level:uint;
            var remainingXpPercentage:uint;
            var currentMapping:CharacterXPMapping;
            var nextMapping:CharacterXPMapping;
            var currentLevelXP:Number;
            var nextLevelXP:Number;
            var firstValue:int;
            var lastValue:int;
            if (desc == null)
            {
            ...
            var sEffect:String = "";
            var hasAddedSpanTag:Boolean;
            var spellModif:Boolean;
            if (desc.indexOf("#") != -1)
            {
