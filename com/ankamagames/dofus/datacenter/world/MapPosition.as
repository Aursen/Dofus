package com.ankamagames.dofus.datacenter.world
{
    ...
    public class MapPosition implements IDataCenter 
    {
        ...
        private static const CAPABILITY_ALLOW_MONSTER_RESPAWN:int = 0x2000;
        private static const CAPABILITY_ALLOW_MONSTER_FIGHT:int = 0x4000;
        private static const CAPABILITY_ALLOW_MOUNT:int = 0x8000;
        private static const CAPABILITY_ALLOW_OBJECT_DISPOSAL:int = 0x10000;
        private static const CAPABILITY_ALLOW_UNDERWATER:int = 0x20000;
        private static const CAPABILITY_ALLOW_PVP_1V1:int = 0x40000;
        private static const CAPABILITY_ALLOW_PVP_3V3:int = 0x80000;
        private static const CAPABILITY_ALLOW_MONSTER_AGRESSION:int = 0x100000;
