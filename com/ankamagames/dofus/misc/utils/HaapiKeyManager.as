package com.ankamagames.dofus.misc.utils
{
    ...
    public class HaapiKeyManager extends EventDispatcher implements IDestroyable 
    {
        ...
        private var _tokens:Dictionary = new Dictionary();
        private var _askedApiKey:Boolean = false;
        private var _askedToken:Boolean = false;
        private var _askedTokens:Vector.<int> = new Vector.<int>();
        private var _accountApi:AccountApi;
        private var _apiKeyCallbacks:Vector.<Function>;
        private var _apiKeyExpirationTimer:Timer = new Timer(ONE_HOUR_IN_MS, 1);
        private var _retryTimer:Timer = new Timer(500, 1);
        ...
        public function callWithApiKey(callback:Function):void
        {
            ...
            else
            {
                ...
                {
                    if (((!(this._askedApiKey)) && (GameServerApproachFrame.authenticationTicketAccepted)))
                    {
