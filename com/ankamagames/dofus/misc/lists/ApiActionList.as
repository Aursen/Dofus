package com.ankamagames.dofus.misc.lists
{
    ...
    public class ApiActionList 
    {
        ...
        public static const ShopOneClickBuyRequest:DofusApiAction = new DofusApiAction("ShopOneClickBuyRequest", ShopOneClickBuyRequestAction);
        public static const ShopOneClickValidateOrderRequest:DofusApiAction = new DofusApiAction("ShopOneClickValidateOrderRequest", ShopOneClickValidateOrderRequestAction);
        public static const ShopOneClickSendCodeRequest:DofusApiAction = new DofusApiAction("ShopOneClickSendCodeRequest", ShopOneClickSendCodeRequestAction);
        ...
        public static const ToggleShowUI:DofusApiAction = new DofusApiAction("ToggleShowUI", ToggleShowUIAction);
        ...
        public static const OpenCodesAndGiftRequest:DofusApiAction = new DofusApiAction("OpenCodesAndGiftRequest", OpenCodesAndGiftRequestAction);
        public static const ConsumeCode:DofusApiAction = new DofusApiAction("ConsumeCode", ConsumeCodeAction);
        public static const UpdateGiftListRequest:DofusApiAction = new DofusApiAction("UpdateGiftListRequest", UpdateGiftListRequestAction);
        public static const ConsumeSimpleKard:DofusApiAction = new DofusApiAction("ConsumeSimpleKard", ConsumeSimpleKardAction);
        public static const ConsumeMultipleKard:DofusApiAction = new DofusApiAction("ConsumeMultipleKard", ConsumeMultipleKardAction);
        public static const AlignmentWarEffortProgressionRequest:DofusApiAction = new DofusApiAction("AlignmentWarEffortProgressionRequest", AlignmentWarEffortProgressionRequestAction);
        public static const CharacterAlignmentWarEffortProgressionRequest:DofusApiAction = new DofusApiAction("CharacterAlignmentWarEffortProgressionRequest", CharacterAlignmentWarEffortProgressionRequestAction);
        public static const AlignmentWarEffortDonate:DofusApiAction = new DofusApiAction("AlignmentWarEffortDonate", AlignmentWarEffortDonateAction);
        public static const ToggleEntityIcons:DofusApiAction = new DofusApiAction("ToggleEntityIcons", ToggleEntityIconsAction);
        public static const OpenTemporisSpellsUi:DofusApiAction = new DofusApiAction("OpenTemporisSpellsUi", OpenTemporisSpellsUiAction);
        public static const ForgettableSpellClientAction:DofusApiAction = new DofusApiAction("ForgettableSpellClientAction", ForgettableSpellClientActionAction);
