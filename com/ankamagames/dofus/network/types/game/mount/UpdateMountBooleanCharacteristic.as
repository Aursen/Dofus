package com.ankamagames.dofus.network.types.game.mount
{
    ...
    public class UpdateMountBooleanCharacteristic extends UpdateMountCharacteristic implements INetworkType 
    {
        ...
        public function initUpdateMountBooleanCharacteristic(_arg_1:uint=0, value:Boolean=false):UpdateMountBooleanCharacteristic
        {
            super.initUpdateMountCharacteristic(_arg_1);
            this.value = value;
            return (this);
        }
