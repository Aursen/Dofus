package com.ankamagames.dofus.network.types.game.dare
{
    ...
    public class DareInformations implements INetworkType 
    {
        ...
        public var creator:CharacterBasicMinimalInformations = new CharacterBasicMinimalInformations();
        ...
        public var criterions:Vector.<DareCriteria> = new Vector.<DareCriteria>();
        ...
        public function serializeAs_DareInformations(output:ICustomDataOutput):void
        {
            ...
            var _i10:uint;
            while (_i10 < this.criterions.length)
            {
                (this.criterions[_i10] as DareCriteria).serializeAs_DareCriteria(output);
                _i10++;
            };
            if (((this.startDate < 0) || (this.startDate > 9007199254740992)))
            {
