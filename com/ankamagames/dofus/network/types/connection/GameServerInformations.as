package com.ankamagames.dofus.network.types.connection
{
    ...
    public class GameServerInformations implements INetworkType 
    {
        ...
        public function initGameServerInformations(id:uint=0, _arg_2:int=-1, isMonoAccount:Boolean=false, status:uint=1, completion:uint=0, isSelectable:Boolean=false, charactersCount:uint=0, charactersSlots:uint=0, date:Number=0):GameServerInformations
        {
            this.id = id;
            this.type = _arg_2;
