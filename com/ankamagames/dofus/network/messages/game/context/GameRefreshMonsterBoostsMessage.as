package com.ankamagames.dofus.network.messages.game.context
{
    ...
    public class GameRefreshMonsterBoostsMessage extends NetworkMessage implements INetworkMessage 
    {
        ...
        public var monsterBoosts:Vector.<MonsterBoosts> = new Vector.<MonsterBoosts>();
        public var familyBoosts:Vector.<MonsterBoosts> = new Vector.<MonsterBoosts>();
        ...
        public function serializeAs_GameRefreshMonsterBoostsMessage(output:ICustomDataOutput):void
        {
            ...
            var _i1:uint;
            while (_i1 < this.monsterBoosts.length)
            {
            ...
            var _i2:uint;
            while (_i2 < this.familyBoosts.length)
            {
        ...
        {
            var _item1:MonsterBoosts;
            var _item2:MonsterBoosts;
            var _monsterBoostsLen:uint = input.readUnsignedShort();
            var _i1:uint;
            while (_i1 < _monsterBoostsLen)
            {
