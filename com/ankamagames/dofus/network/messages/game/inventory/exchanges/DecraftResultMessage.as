package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
    ...
    public class DecraftResultMessage extends NetworkMessage implements INetworkMessage 
    {
        ...
        public var results:Vector.<DecraftedItemStackInfo> = new Vector.<DecraftedItemStackInfo>();
        ...
        {
            var _item1:DecraftedItemStackInfo;
            var _resultsLen:uint = input.readUnsignedShort();
            var _i1:uint;
            while (_i1 < _resultsLen)
            {
