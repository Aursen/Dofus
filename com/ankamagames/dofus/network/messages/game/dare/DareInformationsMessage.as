package com.ankamagames.dofus.network.messages.game.dare
{
    ...
    public class DareInformationsMessage extends NetworkMessage implements INetworkMessage 
    {
        ...
        public static const protocolId:uint = 0x1A00;

        private var _isInitialized:Boolean = false;
        public var dareFixedInfos:DareInformations = new DareInformations();
        public var dareVersatilesInfos:DareVersatileInformations = new DareVersatileInformations();
