package com.ankamagames.dofus.network.messages.game.dare
{
    ...
    public class DareRewardConsumeRequestMessage extends NetworkMessage implements INetworkMessage 
    {
        ...
        public function initDareRewardConsumeRequestMessage(dareId:Number=0, _arg_2:uint=0):DareRewardConsumeRequestMessage
        {
            this.dareId = dareId;
            this.type = _arg_2;
        ...
        {
            if (((this.dareId < -9007199254740992) || (this.dareId > 9007199254740992)))
            {
