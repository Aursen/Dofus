package com.ankamagames.dofus.network.messages.game.interactive.zaap
{
    ...
    public class ZaapDestinationsMessage extends TeleportDestinationsMessage implements INetworkMessage 
    {
        ...
        public function initZaapDestinationsMessage(_arg_1:uint=0, destinations:Vector.<TeleportDestination>=null, spawnMapId:Number=0):ZaapDestinationsMessage
        {
            super.initTeleportDestinationsMessage(_arg_1, destinations);
