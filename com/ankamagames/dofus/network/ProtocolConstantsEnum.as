package com.ankamagames.dofus.network
{
    public class ProtocolConstantsEnum 
    {
        ...
        public static const MAX_CMD_LEN:int = 0x0300;
        public static const MAX_CHAT_LEN:int = 0x0200;
        public static const USER_MAX_CHAT_LEN:int = 0x0100;
        public static const MAX_MOTD_LEN:int = 0x0200;
        public static const USER_MAX_MOTD_LEN:int = 0x0100;
        public static const MAX_BULLETIN_LEN:int = 0x1400;
        public static const USER_MAX_BULLETIN_LEN:int = 0x0A00;
        public static const MAX_STAT_LEN:int = 0x0200;
