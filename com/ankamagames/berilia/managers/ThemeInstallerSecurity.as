package com.ankamagames.berilia.managers
{
    ...
    public class ThemeInstallerSecurity 
    {
        ...
        private static const ONE_KILOBYTES:uint = 0x0400;
        private static const ONE_MEGABYTES:uint = (0x0400 * 0x0400);//0x100000
        ...
        public static function isValidFile(extension:String, data:ByteArray):Boolean
        {
            ...
            switch (extension.toLowerCase())
            {
                case "png":
                    ...
                    {
                        isValid = isValidPNG(data);
                        if (!isValid)
                        {
                            data.position = startPosition;
                            isValid = isValidJPEG(data);
                        };
                    };
                    break;
                case "jpg":
                case "jpeg":
                    ...
                    break;
                case "swf":
                    isValid = ((isValidSWF(data)) && (data.length < (3 * ONE_MEGABYTES)));
                    break;
                case "txt":
                case "xml":
                case "xmls":
