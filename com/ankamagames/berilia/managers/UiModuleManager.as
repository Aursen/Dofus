package com.ankamagames.berilia.managers
{
    ...
    public class UiModuleManager 
    {
        ...
        private var _shortcutsLoadedCallback:Dictionary = new Dictionary();
        ...
        private var _uiFilesLoaded:Vector.<String> = new Vector.<String>();
        private var _remainingUiFilesToLoad:int;
        private var _unparsedXml:Vector.<UiData> = new Vector.<UiData>();
        ...
        private function bindModuleShortcuts(mod:UiModule):void
        {
            ...
            var boundFeatureKeyword:String;
            var shortcut:XML;
            ...
            for each (category in mod.shortcutsXml..category)
            {
                ...
                for each (shortcut in category..shortcut)
                {
                    ...
                    permanent = ((Boolean(shortcut.@permanent)) && (shortcut.@permanent == "true"));
                    visible = ((!(shortcut.@visible)) || (!(shortcut.@visible == "false")));
                    required = ((Boolean(shortcut.@required)) && (shortcut.@required == "true"));
                    holdKeys = ((Boolean(shortcut.@holdKeys)) && (shortcut.@holdKeys == "true"));
