package com.ankamagames.berilia.components
{
    ...
    public class ProgressBar extends GraphicContainer implements UIComponent 
    {
        ...
        public function ProgressBar()
        {
            ...
            _bgAlpha = 1;
            this._barColor = 0xFF00FF;
            this._barAlpha = 1;
            this._innerBarColor = 0xFF00FF;
        ...
        public function set barColor(v:*):void
        {
            ...
            if ((v is String))
            {
                base = ((String(v).substr(0, 2) == "0x") ? 16 : 10);
                v = parseInt(v, base);
            };
            if (((v is int) || (v is uint)))
            {
                newBarColor = v;
                newBarColor = ((newBarColor < 0) ? newBarColor : (newBarColor & 0xFFFFFF));
                if (((v & 0xFF000000) && (!(newBarColor == -1))))
                {
                    newBarAlpha = (((v & 0xFF000000) >> 24) / 0xFF);
                };
            }
            else
            {
        ...
        override public function finalize():void
        {
            ...
            var widthBetweenSeparators:Number;
            var i:int;
            var x:Number;
            ...
            if (this._numberOfSeparators)
            {
                ...
                while (i < totalBlocks)
                {
                    ...
                    var _local_2:* = this._separators.graphics;
                    with (_local_2)
                    {
        ...
        protected function draw():void
        {
            ...
            actualWidth = (((actualWidth < 1) && (!(this._value == 0))) ? 1 : actualWidth);
            var actualInnerWidth:Number = (width * this._innerValue);
            actualInnerWidth = (((actualInnerWidth < 1) && (!(this._innerValue == 0))) ? 1 : actualInnerWidth);
