package com.ankamagames.berilia.components
{
    ...
    public class SubhintComponent extends Texture implements FinalizableUIComponent 
    {
        ...
        public function showSubHint(preview:Boolean=false):void
        {
            ...
            TooltipManager.hide("tuto_interface");
            TooltipManager.show(this._data, ((this.target.name.indexOf("btn_help") == -1) ? this : this.target), this._module, true, "tuto_interface", (((!(this._data.hasOwnProperty("hint_tooltip_position_enum"))) || (this._data.hint_tooltip_position_enum == null)) ? this.findPoint(this.setRelativePoint()) : this.findPoint(this._data.hint_tooltip_position_enum)), (((!(this._data.hasOwnProperty("hint_tooltip_position_enum"))) || (this._data.hint_tooltip_position_enum == null)) ? this.setRelativePoint() : this._data.hint_tooltip_position_enum), new Point(this._data.hint_tooltip_offset_x, this._data.hint_tooltip_offset_y), true, "simpleInterfaceTuto", null, null, null, this._guided, 4, 1, true, true);
        }
