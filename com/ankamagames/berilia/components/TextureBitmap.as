package com.ankamagames.berilia.components
{
    ...
    public class TextureBitmap extends TextureBase implements FinalizableUIComponent 
    {
        ...
        private function drawScale9():void
        {
            ...
            var usedWidth:uint = Math.abs(((this.width) ? this.width : this._bitmapData.width));
            var usedHeight:uint = Math.abs(((this.height) ? this.height : this._bitmapData.height));
            var ox:Number = 0;
            var dx:Number = 0;
        ...
        {
            var usedWidth:uint = ((this.width) ? this.width : this._bitmapData.width);
            var usedHeight:uint = ((this.height) ? this.height : this._bitmapData.height);
        ...
        {
            var usedWidth:int = ((this.width) ? this.width : this._bitmapData.width);
            var usedHeight:int = ((this.height) ? this.height : this._bitmapData.height);
        ...
        internal function drawErrorTexture():void
        {
            graphics.beginFill(0xFF00FF);
            graphics.drawRect(0, 0, ((width != 0) ? width : 10), ((height != 0) ? height : 10));
            graphics.endFill();
        }
