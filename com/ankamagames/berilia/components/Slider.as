package com.ankamagames.berilia.components
{
    ...
    public class Slider extends GraphicContainer implements FinalizableUIComponent 
    {
        ...
        protected var _cursorTexture:Texture = new Texture();
        protected var _cursorDragRegion:Rectangle = new Rectangle();
        protected var _cursorUri:Uri;
        protected var _backgroundUri:Uri = new Uri();
        protected var _value:Number = 5;
        protected var _minValue:Number = 0;
        protected var _maxValue:Number = 10;
        protected var _step:Number;
        public var background:Texture = new Texture();
        ...
        {
            var v:Number = ((isNaN(forceValue)) ? this._value : forceValue);
