package luaAlchemy
{
    ...
    public class LuaAssets 
    {
        ...
        public static function init(_arg_1:*):void
        {
            _arg_1.supplyFile("builtin://lua_alchemy/as3/filegetcontents.lua", (new _asset0() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/as3/onclose.lua", (new _asset1() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/as3/print.lua", (new _asset2() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/as3/sugar.lua", (new _asset3() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/as3/toobject.lua", (new _asset4() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/lua/dofile.lua", (new _asset5() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/lua/print.lua", (new _asset6() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy/lua/strict.lua", (new _asset7() as ByteArray));
            _arg_1.supplyFile("builtin://lua_alchemy.lua", (new _asset8() as ByteArray));
