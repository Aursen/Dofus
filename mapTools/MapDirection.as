package mapTools
{
    public class MapDirection 
    {
        ...
        public function MapDirection():void
        {
        }

        public static function isValidDirection(_arg_1:int):Boolean
        {
            if (_arg_1 >= 0)
            {
                return (_arg_1 <= 7);
        ...
        public static function getOppositeDirection(_arg_1:int):int
        {
            return (_arg_1 ^ 0x04);
        }

        public static function isCardinal(_arg_1:int):Boolean
        {
            return ((_arg_1 & 0x01) == 0);
        }

        public static function isOrthogonal(_arg_1:int):Boolean
        {
