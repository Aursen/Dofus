package mx.events
{
    ...
    public class CollectionEvent extends Event 
    {
        ...
        public function CollectionEvent(_arg_1:String, bubbles:Boolean=false, cancelable:Boolean=false, kind:String=null, location:int=-1, oldLocation:int=-1, items:Array=null)
        {
