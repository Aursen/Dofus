package mx.events
{
    ...
    public class SandboxMouseEvent extends Event 
    {
        ...
        public function SandboxMouseEvent(_arg_1:String, bubbles:Boolean=false, cancelable:Boolean=false, ctrlKey:Boolean=false, altKey:Boolean=false, shiftKey:Boolean=false, buttonDown:Boolean=false)
        {
