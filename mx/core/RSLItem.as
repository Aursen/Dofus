package mx.core
{
    ...
    public class RSLItem 
    {
        ...
        public function itemErrorHandler(event:ErrorEvent):void
        {
            ...
            {
                if (((event.type == SecurityErrorEvent.SECURITY_ERROR) && (!(this.chainedSecurityErrorHandler == null))))
                {
                    this.chainedSecurityErrorHandler(event);
                }
                else
                {
                    if (((event.type == RSLEvent.RSL_ERROR) && (!(this.chainedRSLErrorHandler == null))))
                    {
