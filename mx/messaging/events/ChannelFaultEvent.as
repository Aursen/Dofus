package mx.messaging.events
{
    ...
    public class ChannelFaultEvent extends ChannelEvent 
    {
        ...
        public function ChannelFaultEvent(_arg_1:String, bubbles:Boolean=false, cancelable:Boolean=false, channel:Channel=null, reconnecting:Boolean=false, code:String=null, level:String=null, description:String=null, rejected:Boolean=false, connected:Boolean=false)
        {
            super(_arg_1, bubbles, cancelable, channel, reconnecting, rejected, connected);
            this.faultCode = code;
